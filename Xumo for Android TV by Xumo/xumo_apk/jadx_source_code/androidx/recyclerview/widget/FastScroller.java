...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    void updateScrollPosition(int i, int i2) {
        ...
        if (this.mNeedVerticalScrollbar || this.mNeedHorizontalScrollbar) {
            if (this.mNeedVerticalScrollbar) {
                float f = (float) i3;
                this.mVerticalThumbCenterY = (int) ((f * (((float) i2) + (f / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT))) / ((float) computeVerticalScrollRange));
                this.mVerticalThumbHeight = Math.min(i3, (i3 * i3) / computeVerticalScrollRange);
            }
            if (this.mNeedHorizontalScrollbar != 0) {
                i2 = (float) i4;
                this.mHorizontalThumbCenterX = (int) ((i2 * (((float) i) + (i2 / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT))) / ((float) computeHorizontalScrollRange));
    ...
    private void verticalScrollTo(float f) {
        ...
        if (Math.abs(((float) this.mVerticalThumbCenterY) - f) >= ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) {
    ...
    private void horizontalScrollTo(float f) {
        ...
        if (Math.abs(((float) this.mHorizontalThumbCenterX) - f) >= ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) {
    ...
    L_0x0035:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.FastScroller.isPointInsideVerticalThumb(float, float):boolean");
    }
