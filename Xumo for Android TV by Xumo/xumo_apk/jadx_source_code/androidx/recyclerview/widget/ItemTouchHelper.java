...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        RecoverAnimation(androidx.recyclerview.widget.RecyclerView.ViewHolder r2, int r3, int r4, float r5, float r6, float r7, float r8) {
            ...
            r4 = new androidx.recyclerview.widget.ItemTouchHelper$RecoverAnimation$1;
            r4.<init>();
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.ItemTouchHelper.RecoverAnimation.<init>(androidx.recyclerview.widget.RecyclerView$ViewHolder, int, int, float, float, float, float):void");
        }
        ...
        if (viewHolder2 != this.mSelected || i2 != r11.mActionState) {
            ...
            if (r11.mSelected != null) {
                ...
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    RecoverAnimation anonymousClass3 = new RecoverAnimation(viewHolder3, i6, i3, f2, f3, f, signum) {
                        public void onAnimationEnd(Animator animator) {
