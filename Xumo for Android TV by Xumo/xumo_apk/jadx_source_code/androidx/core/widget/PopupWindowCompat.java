...
public final class PopupWindowCompat {
    ...
    public static void setWindowLayoutType(@androidx.annotation.NonNull android.widget.PopupWindow r6, int r7) {
...
*/
    ...
    L_0x0038:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.PopupWindowCompat.setWindowLayoutType(android.widget.PopupWindow, int):void");
    }

    public static int getWindowLayoutType(@androidx.annotation.NonNull android.widget.PopupWindow r5) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0037:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.PopupWindowCompat.getWindowLayoutType(android.widget.PopupWindow):int");
    }
}
