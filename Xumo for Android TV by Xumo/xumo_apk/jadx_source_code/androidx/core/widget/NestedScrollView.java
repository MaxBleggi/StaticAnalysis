...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (canScroll) {
            if (keyEvent.getAction() == 0) {
                ...
                if (keyCode != 62) {
                    switch (keyCode) {
                        ...
                        case 20:
                            if (keyEvent.isAltPressed() != null) {
                                z = fullScroll(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
                                break;
                            }
                            z = arrowScroll(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
                            break;
                        default:
                            break;
                    }
            ...
            Object findNextFocus = FocusFinder.getInstance().findNextFocus(this, keyEvent, TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
            if (!(findNextFocus == null || findNextFocus == this || findNextFocus.requestFocus(TsExtractor.TS_STREAM_TYPE_HDMV_DTS) == null)) {
                z = true;
            }
            return z;
        }
    ...
    public boolean pageScroll(int i) {
        Object obj = i == TsExtractor.TS_STREAM_TYPE_HDMV_DTS ? 1 : null;
