...
public class TypefaceCompat {
    ...
    public static android.graphics.Typeface createFromResourcesFamilyXml(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.NonNull androidx.core.content.res.FontResourcesParserCompat.FamilyResourceEntry r8, @androidx.annotation.NonNull android.content.res.Resources r9, int r10, int r11, @androidx.annotation.Nullable androidx.core.content.res.ResourcesCompat.FontCallback r12, @androidx.annotation.Nullable android.os.Handler r13, boolean r14) {
        /*
        r4 = r8 instanceof androidx.core.content.res.FontResourcesParserCompat.ProviderResourceEntry;
        if (r4 == 0) goto L_0x002d;
    L_0x0004:
        r0 = r8;
        r0 = (androidx.core.content.res.FontResourcesParserCompat.ProviderResourceEntry) r0;
        r4 = 0;
        r5 = 1;
    ...
    L_0x0020:
        ...
        r3 = r13;
        r6 = r11;
        r0 = androidx.core.provider.FontsContractCompat.getFontSync(r0, r1, r2, r3, r4, r5, r6);
        goto L_0x0042;
    L_0x002d:
        r1 = sTypefaceCompatImpl;
        r0 = r8;
        r0 = (androidx.core.content.res.FontResourcesParserCompat.FontFamilyFilesResourceEntry) r0;
