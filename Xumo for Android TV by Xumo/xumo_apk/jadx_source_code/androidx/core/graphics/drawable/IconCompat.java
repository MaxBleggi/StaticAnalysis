...
public class IconCompat extends CustomVersionedParcelable {
    ...
    public static androidx.core.graphics.drawable.IconCompat createWithResource(android.content.res.Resources r2, java.lang.String r3, @androidx.annotation.DrawableRes int r4) {
...
*/
    ...
    L_0x0004:
        r0 = new androidx.core.graphics.drawable.IconCompat;
        r1 = 2;
        r0.<init>(r1);
        r0.mInt1 = r4;
    ...
    private Drawable loadDrawableInner(Context context) {
        ...
        switch (this.mType) {
            ...
            case 4:
                ...
                if (!Param.CONTENT.equals(scheme)) {
    ...
    public static androidx.core.graphics.drawable.IconCompat createFromIcon(@androidx.annotation.NonNull android.content.Context r2, @androidx.annotation.NonNull android.graphics.drawable.Icon r3) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
