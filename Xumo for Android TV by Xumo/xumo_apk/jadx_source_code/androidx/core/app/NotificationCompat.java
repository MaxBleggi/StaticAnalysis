...
public class NotificationCompat {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (this.mBuilder.mLargeIcon != 0) {
                ...
                if (z && this.mBuilder.mNotification.icon) {
                    z = resources.getDimensionPixelSize(R.dimen.notification_right_icon_size);
                    i = z - (resources.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, z, i, this.mBuilder.getColor()));
                    } else {
            ...
            if (this.mBuilder.mContentInfo != null) {
                ...
                if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    ...
                    if (this.mBuilder.mContentText == null) {
                        ...
                        remoteViews.setViewVisibility(R.id.right_side, i == 0 ? 0 : 8);
                        i = R.id.line3;
                        if (!z) {
                            i2 = 8;
                        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public static final class Message {
            ...
            static androidx.core.app.NotificationCompat.MessagingStyle.Message getMessageFromBundle(android.os.Bundle r6) {
...
*/
            ...
            L_0x001b:
                ...
                r1 = androidx.core.app.Person.fromBundle(r1);	 Catch:{ ClassCastException -> 0x00a7 }
            ...
            L_0x0034:
                ...
                r1 = androidx.core.app.Person.fromAndroidPerson(r1);	 Catch:{ ClassCastException -> 0x00a7 }
                goto L_0x005e;	 Catch:{ ClassCastException -> 0x00a7 }
            L_0x0041:
            ...
            L_0x0049:
                r1 = new androidx.core.app.Person$Builder;	 Catch:{ ClassCastException -> 0x00a7 }
            ...
            L_0x005e:
                r2 = new androidx.core.app.NotificationCompat$MessagingStyle$Message;	 Catch:{ ClassCastException -> 0x00a7 }
...
*/
            /*
            r2 = androidx.core.app.NotificationCompat.getExtras(r2);
            r0 = 0;
        ...
        L_0x0017:
            return r0;
        L_0x0018:
            r1 = new androidx.core.app.NotificationCompat$MessagingStyle;	 Catch:{ ClassCastException -> 0x0021 }
