...
final class GradientColorInflaterCompat {
    ...
    static final class ColorStops {
        ...
        ColorStops(@androidx.annotation.ColorInt int r4, @androidx.annotation.ColorInt int r5) {
            /*
            r3 = this;
            r3.<init>();
            r0 = 2;
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.content.res.GradientColorInflaterCompat.ColorStops.<init>(int, int):void");
        }

        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        ColorStops(@androidx.annotation.ColorInt int r4, @androidx.annotation.ColorInt int r5, @androidx.annotation.ColorInt int r6) {
            /*
            r3 = this;
            r3.<init>();
            r0 = 3;
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.content.res.GradientColorInflaterCompat.ColorStops.<init>(int, int, int):void");
        }
    }
