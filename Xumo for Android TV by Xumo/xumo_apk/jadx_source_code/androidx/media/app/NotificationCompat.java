...
public class NotificationCompat {
    ...
    public static class MediaStyle extends Style {
        ...
        public static Token getMediaSession(Notification notification) {
            notification = androidx.core.app.NotificationCompat.getExtras(notification);
            if (notification != null) {
                if (VERSION.SDK_INT >= 21) {
                    notification = notification.getParcelable(androidx.core.app.NotificationCompat.EXTRA_MEDIA_SESSION);
                    if (notification != null) {
                        return Token.fromToken(notification);
                    }
                }
                notification = BundleCompat.getBinder(notification, androidx.core.app.NotificationCompat.EXTRA_MEDIA_SESSION);
                if (notification != null) {
