        ...
        public Palette generate() {
            ...
            if (this.mBitmap != null) {
                ...
                if (!(scaleBitmapDown == this.mBitmap || rect == null)) {
                    ...
                    Double.isNaN(width2);
                    rect.right = Math.min((int) Math.ceil(width2 * width), scaleBitmapDown.getWidth());
                    width2 = (double) rect.bottom;
                    Double.isNaN(width2);
                    rect.bottom = Math.min((int) Math.ceil(width2 * width), scaleBitmapDown.getHeight());
                }
        ...
        private Bitmap scaleBitmapDown(Bitmap bitmap) {
            ...
            if (this.mResizeArea > 0) {
                ...
                if (width > this.mResizeMaxDimension) {
                    d2 = (double) this.mResizeMaxDimension;
                    d = (double) width;
                    Double.isNaN(d2);
                    Double.isNaN(d);
                    d2 /= d;
