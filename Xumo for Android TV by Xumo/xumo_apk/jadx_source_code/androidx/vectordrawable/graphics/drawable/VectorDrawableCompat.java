                ...
                if (vPath.isClipPath()) {
                    ...
                    if (vFullPath.mStrokeColor.willDraw() != 0) {
                        ...
                        if (i.isGradient()) {
                            ...
                            i.setLocalMatrix(this.mFinalPathMatrix);
                            paint2.setShader(i);
                            paint2.setAlpha(Math.round(vFullPath.mStrokeAlpha * 1132396544));
                        } else {
                            paint2.setShader(null);
                            paint2.setAlpha(255);
                            paint2.setColor(VectorDrawableCompat.applyAlpha(i.getColor(), vFullPath.mStrokeAlpha));
                        }
                        paint2.setColorFilter(colorFilter);
                        paint2.setStrokeWidth(vFullPath.mStrokeWidth * (min * vGroup));
