...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: androidx.legacy.app.ActionBarDrawerToggle.SetIndicatorInfo.<init>(android.app.Activity):void
...
*/
            ...
            r4[r0] = r5;
            r2 = r2.getDeclaredMethod(r3, r4);
            r6.mSetHomeActionContentDescription = r2;
            return;
    ...
    public void onDrawerSlide(View view, float f) {
        ...
        if (f > 0.5f) {
            view = Math.max(view, Math.max(0.0f, f - 0.5f) * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
        } else {
            view = Math.min(view, f * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
        }
