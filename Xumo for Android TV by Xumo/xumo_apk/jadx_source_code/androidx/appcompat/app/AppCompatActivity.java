...
*/
    ...
    L_0x000c:
        r0 = androidx.core.app.TaskStackBuilder.create(r2);
        r2.onCreateSupportNavigateUpTaskStack(r0);
        r2.onPrepareSupportNavigateUpTaskStack(r0);
        r0.startActivities();
        androidx.core.app.ActivityCompat.finishAffinity(r2);	 Catch:{ IllegalStateException -> 0x001d }
        goto L_0x0024;
    L_0x001d:
        r2.finish();
        goto L_0x0024;
    ...
    L_0x0026:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.AppCompatActivity.onSupportNavigateUp():boolean");
    }
