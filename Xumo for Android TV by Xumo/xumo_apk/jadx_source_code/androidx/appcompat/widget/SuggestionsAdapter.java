...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: androidx.appcompat.widget.SuggestionsAdapter.getDrawableFromResourceValue(java.lang.String):android.graphics.drawable.Drawable
...
*/
        ...
        r2.append(r1);
        r2 = r2.toString();
        r3 = r4.checkIconCache(r2);
        if (r3 == 0) goto L_0x003c;
        return r3;
        r3 = r4.mProviderContext;
        r1 = androidx.core.content.ContextCompat.getDrawable(r3, r1);
        r4.storeInIconCache(r2, r1);
        return r1;
...
*/
    ...
    L_0x00ba:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.SuggestionsAdapter.getDrawableFromResourceUri(android.net.Uri):android.graphics.drawable.Drawable");
    }
