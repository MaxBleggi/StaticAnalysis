...
class AppCompatTextHelper {
    ...
    class AnonymousClass1 extends FontCallback {
    ...
    private void updateTypefaceAndStyle(android.content.Context r1, androidx.appcompat.widget.TintTypedArray r2) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: androidx.appcompat.widget.AppCompatTextHelper.updateTypefaceAndStyle(android.content.Context, androidx.appcompat.widget.TintTypedArray):void
...
*/
        ...
        goto L_0x0040;
        r5 = androidx.appcompat.R.styleable.TextAppearance_android_typeface;
        r5 = r6.hasValue(r5);
        ...
        r3 = r4.mView;
        r5.<init>(r3);
        r3 = new androidx.appcompat.widget.AppCompatTextHelper$1;
        r3.<init>(r5);
        r5 = r4.mStyle;
        r5 = r6.getFont(r0, r5, r3);
        r4.mFontTypeface = r5;
        r5 = r4.mFontTypeface;
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes2.hasValue(R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            r0.mDrawableLeftTint = createTintInfo(context, appCompatDrawableManager, obtainStyledAttributes2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (obtainStyledAttributes2.hasValue(R.styleable.AppCompatTextHelper_android_drawableTop)) {
            r0.mDrawableTopTint = createTintInfo(context, appCompatDrawableManager, obtainStyledAttributes2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (obtainStyledAttributes2.hasValue(R.styleable.AppCompatTextHelper_android_drawableRight)) {
            r0.mDrawableRightTint = createTintInfo(context, appCompatDrawableManager, obtainStyledAttributes2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (obtainStyledAttributes2.hasValue(R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            r0.mDrawableBottomTint = createTintInfo(context, appCompatDrawableManager, obtainStyledAttributes2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (VERSION.SDK_INT >= 17) {
            if (obtainStyledAttributes2.hasValue(R.styleable.AppCompatTextHelper_android_drawableStart)) {
                r0.mDrawableStartTint = createTintInfo(context, appCompatDrawableManager, obtainStyledAttributes2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableStart, 0));
            }
            if (obtainStyledAttributes2.hasValue(R.styleable.AppCompatTextHelper_android_drawableEnd)) {
                r0.mDrawableEndTint = createTintInfo(context, appCompatDrawableManager, obtainStyledAttributes2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
            }
        }
    ...
    void onSetTextAppearance(Context context, int i) {
        ...
        if (i.hasValue(R.styleable.TextAppearance_android_textSize) && i.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, -1) == 0) {
