...
*/
    ...
    L_0x0004:
        ...
        r0 = (androidx.core.text.PrecomputedTextCompat) r0;	 Catch:{ InterruptedException -> 0x0012, InterruptedException -> 0x0012 }
        androidx.core.widget.TextViewCompat.setPrecomputedText(r2, r0);	 Catch:{ InterruptedException -> 0x0012, InterruptedException -> 0x0012 }
    L_0x0012:
        return;
        */
