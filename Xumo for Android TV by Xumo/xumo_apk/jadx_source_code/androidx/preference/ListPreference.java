...
public class ListPreference extends DialogPreference {
    ...
    public ListPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mSummary = TypedArrayUtils.getString(context, R.styleable.Preference_summary, R.styleable.Preference_android_summary);
        context.recycle();
    }
    ...
    public void setValue(String str) {
        int equals = TextUtils.equals(this.mValue, str) ^ 1;
        if (equals != 0 || !this.mValueSet) {
            this.mValue = str;
            this.mValueSet = true;
            persistString(str);
            if (equals != 0) {
