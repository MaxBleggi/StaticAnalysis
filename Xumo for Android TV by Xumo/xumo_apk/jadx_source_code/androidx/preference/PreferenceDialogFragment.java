...
public abstract class PreferenceDialogFragment extends DialogFragment implements OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        Builder negativeButton = new Builder(bundle).setTitle(this.mDialogTitle).setIcon(this.mDialogIcon).setPositiveButton(this.mPositiveButtonText, this).setNegativeButton(this.mNegativeButtonText, this);
        bundle = onCreateDialogView(bundle);
        if (bundle != null) {
            onBindDialogView(bundle);
            negativeButton.setView(bundle);
        } else {
