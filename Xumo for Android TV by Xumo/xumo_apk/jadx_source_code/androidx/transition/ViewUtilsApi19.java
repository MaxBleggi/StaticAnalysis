...
class ViewUtilsApi19 extends ViewUtilsBase {
    ...
    public void setTransitionAlpha(@androidx.annotation.NonNull android.view.View r4, float r5) {
...
*/
    ...
    L_0x0025:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ViewUtilsApi19.setTransitionAlpha(android.view.View, float):void");
    }

    public float getTransitionAlpha(@androidx.annotation.NonNull android.view.View r3) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
