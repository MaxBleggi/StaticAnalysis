...
public class Placeholder extends View {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            attributeSet = getContext().obtainStyledAttributes(attributeSet, R.styleable.ConstraintLayout_placeholder);
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            canvas.drawText(str, ((((float) width) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - (((float) rect.width()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) - ((float) rect.left), ((((float) height) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) + (((float) rect.height()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) - ((float) rect.bottom), paint);
        }
    }
