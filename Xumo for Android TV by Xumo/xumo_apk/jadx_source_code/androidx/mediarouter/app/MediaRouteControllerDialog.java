        ...
        public void onClick(View view) {
            ...
            if (view != 16908313) {
                if (view != MediaRouteControllerDialog.BUTTON_DISCONNECT_RES_ID) {
                    if (view == R.id.mr_control_playback_ctrl) {
...
*/
        ...
        L_0x007f:
            ...
            r4 = androidx.mediarouter.app.MediaRouteControllerDialog.this;	 Catch:{ IOException -> 0x0035 }
        ...
        L_0x00df:
            r8 = r2;
        L_0x00e0:
            r3 = androidx.mediarouter.app.MediaRouteControllerDialog.isBitmapRecycled(r8);
...
*/
                /*
                r2 = this;
                r3 = androidx.mediarouter.app.MediaRouteControllerDialog.this;
            ...
            L_0x0010:
                ...
                r0 = androidx.mediarouter.app.MediaRouteControllerDialog.this;	 Catch:{ CanceledException -> 0x0019 }
            ...
            L_0x002f:
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.mediarouter.app.MediaRouteControllerDialog.4.onClick(android.view.View):void");
            }
        };
                                    ...
                                    if (this.mState.getState() != 6) {
                                        if (this.mState.getState() == 3) {
                                            ...
                                            if (obj == null && isPauseActionSupported()) {
                                                ...
                                                isEmpty = R.string.mr_controller_pause;
                                            } else if (obj == null && isStopActionSupported()) {
                                                i = R.attr.mediaRouteStopDrawable;
                                                isEmpty = R.string.mr_controller_stop;
                                                ...
                                                isEmpty = R.string.mr_controller_play;
                                            }
