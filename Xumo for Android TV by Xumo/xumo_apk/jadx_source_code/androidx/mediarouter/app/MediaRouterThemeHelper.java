...
final class MediaRouterThemeHelper {
    ...
    private static Drawable getDrawableIcon(Context context, int i) {
        context = context.obtainStyledAttributes(new int[]{R.attr.mediaRouteDefaultIconDrawable, R.attr.mediaRouteTvIconDrawable, R.attr.mediaRouteSpeakerIconDrawable, R.attr.mediaRouteSpeakerGroupIconDrawable});
    ...
    static Context createThemedButtonContext(Context context) {
        ...
        context = getThemeResource(contextThemeWrapper, R.attr.mediaRouteTheme);
    ...
    static Context createThemedDialogContext(Context context, int i, boolean z) {
        ...
        return getThemeResource(z, R.attr.mediaRouteTheme) != null ? new ContextThemeWrapper(z, getRouterThemeId(z)) : z;
    }
    ...
    private static boolean isLightTheme(Context context) {
        TypedValue typedValue = new TypedValue();
        return (context.getTheme().resolveAttribute(androidx.appcompat.R.attr.isLightTheme, typedValue, true) == null || typedValue.data == null) ? false : true;
    }
