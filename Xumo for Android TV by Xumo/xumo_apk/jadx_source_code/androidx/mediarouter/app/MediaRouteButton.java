...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, R.styleable.MediaRouteButton, i, 0);
        this.mButtonTint = context.getColorStateList(R.styleable.MediaRouteButton_mediaRouteButtonTint);
        this.mMinWidth = context.getDimensionPixelSize(R.styleable.MediaRouteButton_android_minWidth, 0);
        this.mMinHeight = context.getDimensionPixelSize(R.styleable.MediaRouteButton_android_minHeight, 0);
        attributeSet = context.getResourceId(R.styleable.MediaRouteButton_externalRouteEnabledDrawable, 0);
        context.recycle();
    ...
    void setCheatSheetEnabled(boolean z) {
        TooltipCompat.setTooltipText(this, z ? getContext().getString(R.string.mr_button_content_description) : false);
    }
