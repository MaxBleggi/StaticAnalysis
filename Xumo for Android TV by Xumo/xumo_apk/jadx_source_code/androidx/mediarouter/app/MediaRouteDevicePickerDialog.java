...
public class MediaRouteDevicePickerDialog extends AppCompatDialog {
    ...
    public MediaRouteDevicePickerDialog(Context context, int i) {
        ...
        this.mUpdateRoutesDelayMs = (long) context.getResources().getInteger(R.integer.mr_update_routes_delay_ms);
    }
    ...
    public void refreshRoutes() {
        if (this.mAttachedToWindow) {
            ...
            this.mHandler.removeMessages(1);
            this.mHandler.sendMessageAtTime(this.mHandler.obtainMessage(1, arrayList), this.mLastUpdateTime + this.mUpdateRoutesDelayMs);
        }
    }
