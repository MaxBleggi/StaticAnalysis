    ...
    private static final class GlobalMediaRouter implements SyncCallback, androidx.mediarouter.media.RegisteredMediaRouteProviderWatcher.Callback {
        ...
        private final class MediaSessionRecord {
            ...
            public Token getToken() {
                return this.mMsCompat != null ? this.mMsCompat.getSessionToken() : null;
            }
        }
...
*/
        ...
        L_0x0013:
            ...
            return r3;
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.mediarouter.media.MediaRouter.GlobalMediaRouter.getProviderContext(java.lang.String):android.content.Context");
        }
                        ...
                        for (int i2 = 0; i2 < size2; i2++) {
                            ...
                            if (findRouteByDescriptorId < 0) {
                                ...
                                if ((routeGroup instanceof RouteGroup) != z3) {
                                    RouteInfo routeGroup2;
                                    if (z3) {
                                        routeGroup2 = new RouteGroup(providerInfo2, id, routeGroup.getId());
                                    } else {
                                        routeGroup2 = new RouteInfo(providerInfo2, id, routeGroup.getId());
                                    }
                                    routeGroup = routeGroup2;
...
*/
        ...
        L_0x003f:
            r2 = r0.next();
            r2 = (androidx.mediarouter.media.MediaRouter.RouteInfo) r2;
        ...
        L_0x00a9:
            r1 = r0.next();
            r1 = (androidx.mediarouter.media.MediaRouter.RouteInfo) r1;
        ...
        L_0x00e5:
            ...
            r5 = r5 instanceof androidx.mediarouter.media.MediaRouter.RouteGroup;
            if (r5 == 0) goto L_0x0171;
        L_0x00eb:
            r5 = r4.mSelectedRoute;
            r5 = (androidx.mediarouter.media.MediaRouter.RouteGroup) r5;
            r5 = r5.getRoutes();
        ...
        L_0x012e:
            r2 = r2.getValue();
            r2 = (androidx.mediarouter.media.MediaRouteProvider.RouteController) r2;
            r2.onUnselect();
            r2.onRelease();
            r1.remove();
            goto L_0x0118;
        ...
        L_0x0148:
            r0 = r5.next();
            r0 = (androidx.mediarouter.media.MediaRouter.RouteInfo) r0;
            r1 = r4.mRouteControllerMap;
            r2 = r0.mDescriptorId;
        ...
        L_0x0195:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.mediarouter.media.MediaRouter.GlobalMediaRouter.updateSelectedRouteIfNeeded(boolean):void");
        }
