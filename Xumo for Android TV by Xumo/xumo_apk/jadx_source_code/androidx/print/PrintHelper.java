...
*/
                        /*
                        r1 = this;
                        r2 = androidx.print.PrintHelper.PrintUriAdapter.this;	 Catch:{ FileNotFoundException -> 0x000d }
                        r2 = androidx.print.PrintHelper.this;	 Catch:{ FileNotFoundException -> 0x000d }
                        r0 = androidx.print.PrintHelper.PrintUriAdapter.this;	 Catch:{ FileNotFoundException -> 0x000d }
                    ...
                    L_0x000d:
                        ...
                        return r2;
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.print.PrintHelper.PrintUriAdapter.1.doInBackground(android.net.Uri[]):android.graphics.Bitmap");
                    }
    ...
    static Matrix getMatrix(int i, int i2, RectF rectF, int i3) {
        ...
        matrix.postTranslate((rectF.width() - (i * i3)) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, (rectF.height() - (((float) i2) * i3)) / 1073741824);
        return matrix;
    }
...
*/
            ...
            L_0x00e2:
                ...
                return r8;
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.print.PrintHelper.1.doInBackground(java.lang.Void[]):java.lang.Throwable");
            }
