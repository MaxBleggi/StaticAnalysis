...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        void draw(Canvas canvas, Rect rect) {
            ...
            float f = this.mRingCenterRadius + (this.mStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
            if (this.mRingCenterRadius <= 0.0f) {
                f = (((float) Math.min(rect.width(), rect.height())) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - Math.max((((float) this.mArrowWidth) * this.mArrowScale) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, this.mStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
            }
            ...
            f = this.mStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
            rectF.inset(f, f);
            canvas.drawCircle(rectF.centerX(), rectF.centerY(), rectF.width() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, this.mCirclePaint);
            f = -f;
            rectF.inset(f, f);
        ...
        void drawTriangle(Canvas canvas, float f, float f2, RectF rectF) {
            if (this.mShowArrow) {
                ...
                float min = Math.min(rectF.width(), rectF.height()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
                float f3 = (((float) this.mArrowWidth) * this.mArrowScale) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
                ...
                this.mArrow.offset((min + rectF.centerX()) - f3, rectF.centerY() + (this.mStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT));
                this.mArrow.close();
