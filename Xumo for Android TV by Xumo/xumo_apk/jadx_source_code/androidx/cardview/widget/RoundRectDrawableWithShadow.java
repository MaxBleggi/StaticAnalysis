...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private int toEven(float f) {
        f = (int) (f + 0.5f);
        return f % 2 == 1 ? f - Cue.DIMEN_UNSET : f;
    }
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f2 = (this.mCornerRadius + ((float) this.mInsetShadow)) + (this.mRawShadowSize / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
        float f3 = f2 * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
    ...
    float getMinWidth() {
        return (Math.max(this.mRawMaxShadowSize, (this.mCornerRadius + ((float) this.mInsetShadow)) + (this.mRawMaxShadowSize / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) + ((this.mRawMaxShadowSize + ((float) this.mInsetShadow)) * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    }

    float getMinHeight() {
        return (Math.max(this.mRawMaxShadowSize, (this.mCornerRadius + ((float) this.mInsetShadow)) + ((this.mRawMaxShadowSize * SHADOW_MULTIPLIER) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) + (((this.mRawMaxShadowSize * SHADOW_MULTIPLIER) + ((float) this.mInsetShadow)) * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    }
