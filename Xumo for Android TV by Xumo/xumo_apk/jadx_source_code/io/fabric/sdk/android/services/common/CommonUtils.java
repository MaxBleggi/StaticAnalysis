...
public class CommonUtils {
        ...
        if (file.exists()) {
            try {
                ...
                try {
                    ...
                    logger.e(str3, stringBuilder.toString(), str);
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Fabric.getLogger().e(Fabric.TAG, "Could not calculate hash for app icon.", inputStream2);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            logger.e(str2, stringBuilder.toString(), bArr2);
            return "";
        }
    }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Fabric.getLogger().e(Fabric.TAG, str, closeable2);
            }
        }
    }
    ...
    public static void flushOrLog(Flushable flushable, String str) {
        if (flushable != null) {
            try {
                ...
                Fabric.getLogger().e(Fabric.TAG, str, flushable2);
            }
        }
    }
