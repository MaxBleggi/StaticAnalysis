...
*/
    ...
    public static String encode(CharSequence charSequence) throws HttpRequestException {
        try {
            ...
            try {
                charSequence = new URI(url.getProtocol(), charSequence, url.getPath(), url.getQuery(), url.getRef()).toASCIIString();
                ...
                stringBuilder2.append(charSequence.substring(indexOf).replace("+", "%2B").replace("#", "%23"));
    ...
    private static String setProperty(final String str, final String str2) {
        PrivilegedAction anonymousClass1;
        if (str2 != null) {
            anonymousClass1 = new PrivilegedAction<String>() {
                public String run() {
        ...
        return (String) AccessController.doPrivileged(anonymousClass1);
    }
    ...
    public HttpRequest contentType(String str, String str2) {
        ...
        String str3 = HEADER_CONTENT_TYPE;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(str);
        stringBuilder.append("; charset=");
        stringBuilder.append(str2);
        return header(str3, stringBuilder.toString());
    }
