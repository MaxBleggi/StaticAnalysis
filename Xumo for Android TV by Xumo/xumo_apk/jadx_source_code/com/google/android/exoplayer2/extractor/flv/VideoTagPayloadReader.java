...
final class VideoTagPayloadReader extends TagPayloadReader {
    ...
    protected void parsePayload(ParsableByteArray parsableByteArray, long j) throws ParserException {
        ...
        if (readUnsignedByte == 0 && !this.hasOutputFormat) {
            ...
            this.output.format(Format.createVideoSampleFormat(null, MimeTypes.VIDEO_H264, null, -1, -1, parsableByteArray.width, parsableByteArray.height, -1.0f, parsableByteArray.initializationData, -1, parsableByteArray.pixelWidthAspectRatio, null));
