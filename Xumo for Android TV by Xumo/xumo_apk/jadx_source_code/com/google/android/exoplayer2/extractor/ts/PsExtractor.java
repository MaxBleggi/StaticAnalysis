...
public final class PsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        int i = 0;
        if (!((this.timestampAdjuster.getTimestampOffsetUs() == C.TIME_UNSET ? 1 : null) == null && (this.timestampAdjuster.getFirstSampleTimestampUs() == 0 || this.timestampAdjuster.getFirstSampleTimestampUs() == j2))) {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        if ((length != -1 ? 1 : null) != null && !this.durationReader.isDurationReadFinished()) {
        ...
        length = length != -1 ? length - extractorInput.getPeekPosition() : -1;
        if ((length != -1 && length < 4) || !extractorInput.peekFully(this.psPacketBuffer.data, 0, 4, true)) {
            return -1;
        }
        ...
        if (readInt == PACK_START_CODE) {
            ...
            if (!this.foundAllTracks) {
                ...
                long j = (this.foundAudioTrack == null || this.foundVideoTrack == null) ? 1048576 : this.lastTrackPosition + 8192;
