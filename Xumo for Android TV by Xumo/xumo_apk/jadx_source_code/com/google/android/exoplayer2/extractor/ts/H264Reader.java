...
public final class H264Reader implements ElementaryStreamReader {
                                            ...
                                            if (spsData.picOrderCountType != 0) {
                                                if (!r0.bitArray.canReadBits(spsData.picOrderCntLsbLength)) {
                                                    ...
                                                    if (ppsData.bottomFieldPicOrderInFramePresentFlag || z) {
                                                        ...
                                                        readSignedExpGolombCodedInt = r0.bitArray.readSignedExpGolombCodedInt();
                                                        i6 = i4;
                                                        i7 = 0;
                                                        i8 = 0;
                                                        r0.sliceHeader.setAll(spsData, readBits, readUnsignedExpGolombCodedInt, readBits2, readUnsignedExpGolombCodedInt2, z, z2, readBit, z3, i5, i6, readSignedExpGolombCodedInt, i7, i8);
                                                        r0.isFilling = false;
                                                    } else {
                                                        return;
                                                    }
                                                ...
                                                if (!ppsData.bottomFieldPicOrderInFramePresentFlag || z) {
                                                    ...
                                                    i8 = r0.bitArray.readSignedExpGolombCodedInt();
                                                    i7 = i4;
                                                    i6 = 0;
                                                    readSignedExpGolombCodedInt = 0;
                                                    r0.sliceHeader.setAll(spsData, readBits, readUnsignedExpGolombCodedInt, readBits2, readUnsignedExpGolombCodedInt2, z, z2, readBit, z3, i5, i6, readSignedExpGolombCodedInt, i7, i8);
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            parsableByteArray = NalUnitUtil.findNalUnit(bArr, position, limit, this.prefixFlags);
            if (parsableByteArray == limit) {
                nalUnitData(bArr, position, limit);
                return;
            }
            int nalUnitType = NalUnitUtil.getNalUnitType(bArr, parsableByteArray);
            int i = parsableByteArray - position;
            if (i > 0) {
                nalUnitData(bArr, position, parsableByteArray);
            }
            int i2 = limit - parsableByteArray;
            long j = this.totalBytesWritten - ((long) i2);
            endNalUnit(j, i2, i < 0 ? -i : 0, this.pesTimeUs);
            startNalUnit(j, nalUnitType, this.pesTimeUs);
            position = parsableByteArray + 3;
        }
    }
