...
final class VorbisUtil {
    ...
    public static VorbisIdHeader readVorbisIdentificationHeader(ParsableByteArray parsableByteArray) throws ParserException {
        ...
        return new VorbisIdHeader(readLittleEndianUnsignedInt, readUnsignedByte, readLittleEndianUnsignedInt2, readLittleEndianInt, readLittleEndianInt2, readLittleEndianInt3, (int) Math.pow(MediaLoadOptions.PLAYBACK_RATE_MAX, (double) (readUnsignedByte2 & 15)), (int) Math.pow(MediaLoadOptions.PLAYBACK_RATE_MAX, (double) ((readUnsignedByte2 & PsExtractor.VIDEO_STREAM_MASK) >> 4)), (parsableByteArray.readUnsignedByte() & 1) > 0, Arrays.copyOf(parsableByteArray2.data, parsableByteArray.limit()));
    }
    ...
    private static CodeBook readBook(VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        stringBuilder2.append(vorbisBitArray.getPosition());
