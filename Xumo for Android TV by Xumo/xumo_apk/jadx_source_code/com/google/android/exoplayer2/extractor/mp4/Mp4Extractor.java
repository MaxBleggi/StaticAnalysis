...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private boolean readAtomHeader(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (this.atomSize >= ((long) this.atomHeaderBytesRead)) {
            if (shouldParseContainerAtom(this.atomType)) {
                ...
                Assertions.checkState(this.atomHeaderBytesRead == 8 ? true : null);
                Assertions.checkState(this.atomSize <= 2147483647L ? true : null);
    ...
    private void processMoovAtom(ContainerAtom containerAtom) throws ParserException {
        ...
        int i = 1;
        int i2 = 0;
        ArrayList trackSampleTables = getTrackSampleTables(containerAtom2, gaplessInfoHolder, (mp4Extractor.flags & 1) != 0);
        ...
        while (i2 < size) {
            ...
            Mp4Track mp4Track = new Mp4Track(track, trackSampleTable, mp4Extractor.extractorOutput.track(i2, track.type));
        ...
        mp4Extractor.firstVideoTrackIndex = i3;
        ...
        for (int i3 = 0; i3 < mp4Extractor.tracks.length; i3++) {
            ...
            if (i4 != mp4Track.sampleTable.sampleCount) {
                ...
                if (j5 >= 0) {
                    if (j5 < 262144) {
                        obj3 = null;
                        if ((obj3 == null && r13 != null) || (obj3 == r13 && j5 < r14)) {
                            obj2 = obj3;
                            i = i3;
                            j4 = j5;
                            j3 = j6;
