...
*/
    ...
    public synchronized Extractor[] createExtractors() {
        ...
        extractorArr[3] = new Mp3Extractor(this.mp3Flags | this.constantBitrateSeekingEnabled);
        extractorArr[4] = new AdtsExtractor(0, this.adtsFlags | this.constantBitrateSeekingEnabled);
        ...
        extractorArr[11] = new AmrExtractor(this.amrFlags | this.constantBitrateSeekingEnabled);
