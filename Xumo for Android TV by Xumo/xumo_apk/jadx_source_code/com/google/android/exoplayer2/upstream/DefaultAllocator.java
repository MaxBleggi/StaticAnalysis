        ...
        for (Allocation allocation : allocationArr) {
            if (allocation.data != this.initialAllocationBlock) {
                if (allocation.data.length != this.individualAllocationSize) {
                    ...
                    stringBuilder.append("Unexpected allocation: ");
                    stringBuilder.append(System.identityHashCode(allocation.data));
                    stringBuilder.append(", ");
                    stringBuilder.append(System.identityHashCode(this.initialAllocationBlock));
                    stringBuilder.append(", ");
                    stringBuilder.append(allocation.data.length);
                    stringBuilder.append(", ");
                    stringBuilder.append(this.individualAllocationSize);
