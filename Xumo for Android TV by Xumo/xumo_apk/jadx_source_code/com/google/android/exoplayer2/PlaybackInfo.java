...
final class PlaybackInfo {
    public static final MediaPeriodId DUMMY_MEDIA_PERIOD_ID = new MediaPeriodId(new Object());
    ...
    public PlaybackInfo fromNewPosition(MediaPeriodId mediaPeriodId, long j, long j2) {
        return new PlaybackInfo(this.timeline, this.manifest, mediaPeriodId, j, mediaPeriodId.isAd() ? j2 : C.TIME_UNSET, r0.playbackState, r0.isLoading, r0.trackGroups, r0.trackSelectorResult, mediaPeriodId, j, 0, j);
    }
