...
public final class CodecSpecificDataUtil {
    ...
    public static Pair<Integer, Integer> parseAacAudioSpecificConfig(ParsableBitArray parsableBitArray, boolean z) throws ParserException {
        ...
        if (aacAudioObjectType || aacAudioObjectType) {
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i, int i2) {
        ...
        i3 = -1;
        for (int i5 = 0; i5 < AUDIO_SPECIFIC_CONFIG_CHANNEL_COUNT_TABLE.length; i5++) {
            if (i2 == AUDIO_SPECIFIC_CONFIG_CHANNEL_COUNT_TABLE[i5]) {
                i3 = i5;
            }
        }
        if (i != -1 && i3 != -1) {
            return buildAacAudioSpecificConfig(2, i4, i3);
        }
        StringBuilder stringBuilder = new StringBuilder();
