...
public final class Util {
    ...
    public static ExecutorService newSingleThreadExecutor(String str) {
        return Executors.newSingleThreadExecutor(new -$$Lambda$Util$MRC4FgxCpRGDforKj-F0m_7VaCA(str));
    }

    public static void closeQuietly(com.google.android.exoplayer2.upstream.DataSource r0) {
...
*/
    ...
    L_0x0005:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.util.Util.closeQuietly(com.google.android.exoplayer2.upstream.DataSource):void");
    }
...
*/
    ...
    L_0x0005:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.util.Util.closeQuietly(java.io.Closeable):void");
    }
    ...
    public static java.lang.String normalizeLanguageCode(@androidx.annotation.Nullable java.lang.String r1) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    public static long[] scaleLargeTimestamps(List<Long> list, long j, long j2) {
        ...
        if (j2 >= j && j2 % j == 0) {
            ...
            j /= j2;
            while (i < jArr.length) {
                j2 = (double) ((Long) list.get(i)).longValue();
                Double.isNaN(j2);
                jArr[i] = (long) (j2 * j);
                i++;
            }
    ...
    public static long resolveSeekPositionUs(long j, SeekParameters seekParameters, long j2, long j3) {
        ...
        seekParameters = true;
        Object obj = (subtractWithOverflowDefault > j2 || j2 > addWithOverflowDefault) ? null : 1;
        if (subtractWithOverflowDefault > j3 || j3 > addWithOverflowDefault) {
            seekParameters = null;
        }
        if (obj != null && seekParameters != null) {
            return Math.abs(j2 - j) <= Math.abs(j3 - j) ? j2 : j3;
        } else {
            if (obj != null) {
                return j2;
            }
            return seekParameters != null ? j3 : subtractWithOverflowDefault;
        }
    }
...
*/
    ...
    L_0x0012:
        ...
        r2 = ") ";
        r0.append(r2);
        r2 = "ExoPlayerLib/2.9.0";
        r0.append(r2);
        r2 = r0.toString();
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.util.Util.getUserAgent(android.content.Context, java.lang.String):java.lang.String");
    }
...
*/
    ...
    public static int inferContentType(Uri uri, String str) {
        ...
        uri.append(".");
        uri.append(str);
        return inferContentType(uri.toString());
    }
    ...
    public static int getNetworkType(@androidx.annotation.Nullable android.content.Context r2) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0003:
        return r0;
    L_0x0004:
        r1 = "connectivity";	 Catch:{ SecurityException -> 0x0033 }
        r2 = r2.getSystemService(r1);	 Catch:{ SecurityException -> 0x0033 }
        r2 = (android.net.ConnectivityManager) r2;	 Catch:{ SecurityException -> 0x0033 }
        if (r2 != 0) goto L_0x000f;	 Catch:{ SecurityException -> 0x0033 }
    L_0x000e:
        return r0;	 Catch:{ SecurityException -> 0x0033 }
    L_0x000f:
        r2 = r2.getActiveNetworkInfo();	 Catch:{ SecurityException -> 0x0033 }
    ...
    L_0x0033:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.util.Util.getNetworkType(android.content.Context):int");
    }
        ...
        if (context != null) {
            ...
            if (telephonyManager != null) {
                ...
                if (!TextUtils.isEmpty(context)) {
                    return toUpperInvariant(context);
                }
            }
        }
    ...
    public static boolean inflate(com.google.android.exoplayer2.util.ParsableByteArray r4, com.google.android.exoplayer2.util.ParsableByteArray r5, @androidx.annotation.Nullable java.util.zip.Inflater r6) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0020:
        ...
        r4 = 0;
    L_0x002e:
        r2 = r0.length;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        r2 = r2 - r4;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        r2 = r6.inflate(r0, r4, r2);	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        r4 = r4 + r2;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        r2 = r6.finished();	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        if (r2 == 0) goto L_0x0043;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
    L_0x003b:
        r5.reset(r0, r4);	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        r4 = 1;
        r6.reset();
        return r4;
    L_0x0043:
        r2 = r6.needsDictionary();	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        if (r2 != 0) goto L_0x005b;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
    L_0x0049:
        r2 = r6.needsInput();	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        if (r2 == 0) goto L_0x0050;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
    L_0x004f:
        goto L_0x005b;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
    L_0x0050:
        r2 = r0.length;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        if (r4 != r2) goto L_0x002e;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
    L_0x0053:
        r2 = r0.length;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        r2 = r2 * 2;	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        r0 = java.util.Arrays.copyOf(r0, r2);	 Catch:{ DataFormatException -> 0x0064, all -> 0x005f }
        goto L_0x002e;
    L_0x005b:
        r6.reset();
        return r1;
...
*/
    ...
    L_0x0076:
        ...
        r0 = 0;
        r1 = 1;
        r2 = "android.os.SystemProperties";	 Catch:{ Exception -> 0x0099 }
        r2 = java.lang.Class.forName(r2);	 Catch:{ Exception -> 0x0099 }
        r3 = "get";	 Catch:{ Exception -> 0x0099 }
        r4 = new java.lang.Class[r1];	 Catch:{ Exception -> 0x0099 }
        r5 = java.lang.String.class;	 Catch:{ Exception -> 0x0099 }
        r4[r0] = r5;	 Catch:{ Exception -> 0x0099 }
        r3 = r2.getMethod(r3, r4);	 Catch:{ Exception -> 0x0099 }
        r4 = new java.lang.Object[r1];	 Catch:{ Exception -> 0x0099 }
        r5 = "sys.display-size";	 Catch:{ Exception -> 0x0099 }
        r4[r0] = r5;	 Catch:{ Exception -> 0x0099 }
        r2 = r3.invoke(r2, r4);	 Catch:{ Exception -> 0x0099 }
        r2 = (java.lang.String) r2;	 Catch:{ Exception -> 0x0099 }
        r6 = r2;
        goto L_0x00a1;
    L_0x0099:
        r2 = move-exception;
        ...
        com.google.android.exoplayer2.util.Log.e(r3, r4, r2);
    L_0x00a1:
        r2 = android.text.TextUtils.isEmpty(r6);
        if (r2 != 0) goto L_0x00e1;
    L_0x00a7:
        r2 = r6.trim();	 Catch:{ NumberFormatException -> 0x00cb }
        r3 = "x";	 Catch:{ NumberFormatException -> 0x00cb }
        r2 = split(r2, r3);	 Catch:{ NumberFormatException -> 0x00cb }
        r3 = r2.length;	 Catch:{ NumberFormatException -> 0x00cb }
        r4 = 2;	 Catch:{ NumberFormatException -> 0x00cb }
        if (r3 != r4) goto L_0x00cb;	 Catch:{ NumberFormatException -> 0x00cb }
    L_0x00b5:
        r0 = r2[r0];	 Catch:{ NumberFormatException -> 0x00cb }
        r0 = java.lang.Integer.parseInt(r0);	 Catch:{ NumberFormatException -> 0x00cb }
        r1 = r2[r1];	 Catch:{ NumberFormatException -> 0x00cb }
        r1 = java.lang.Integer.parseInt(r1);	 Catch:{ NumberFormatException -> 0x00cb }
        if (r0 <= 0) goto L_0x00cb;	 Catch:{ NumberFormatException -> 0x00cb }
    L_0x00c3:
        if (r1 <= 0) goto L_0x00cb;	 Catch:{ NumberFormatException -> 0x00cb }
    L_0x00c5:
        r2 = new android.graphics.Point;	 Catch:{ NumberFormatException -> 0x00cb }
        r2.<init>(r0, r1);	 Catch:{ NumberFormatException -> 0x00cb }
        return r2;
    L_0x00cb:
        r0 = "Util";
        ...
        r1.append(r6);
        r6 = r1.toString();
        com.google.android.exoplayer2.util.Log.e(r0, r6);
    L_0x00e1:
        r6 = new android.graphics.Point;
        r6.<init>();
        r0 = SDK_INT;
