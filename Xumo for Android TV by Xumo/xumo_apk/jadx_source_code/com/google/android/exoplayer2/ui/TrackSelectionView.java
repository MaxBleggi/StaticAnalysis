...
public class TrackSelectionView extends LinearLayout {
    ...
    public static Pair<AlertDialog, TrackSelectionView> getDialog(Activity activity, CharSequence charSequence, DefaultTrackSelector defaultTrackSelector, int i) {
        ...
        activity = LayoutInflater.from(builder.getContext()).inflate(R.layout.exo_track_selection_dialog, null);
        TrackSelectionView trackSelectionView = (TrackSelectionView) activity.findViewById(R.id.exo_track_selection_view);
        trackSelectionView.init(defaultTrackSelector, i);
        return Pair.create(builder.setTitle(charSequence).setView(activity).setPositiveButton(17039370, new -$$Lambda$TrackSelectionView$Fni8J5PCSkla_I2ocA1wVoa_7Zg(trackSelectionView)).setNegativeButton(17039360, null).create(), trackSelectionView);
    }
    ...
    public void setShowDisableOption(boolean z) {
        this.disableView.setVisibility(z ? false : true);
    }
        ...
        if (this.trackSelector != null) {
            if (mappedTrackInfo != null) {
                ...
                for (int i = 0; i < this.trackGroups.length; i++) {
                    ...
                    Object obj = (!this.allowAdaptiveSelections || this.trackGroups.get(i).length <= 1 || mappedTrackInfo.getAdaptiveSupport(this.rendererIndex, i, false) == 0) ? null : 1;
                    this.trackViews[i] = new CheckedTextView[trackGroup.length];
                    for (int i2 = 0; i2 < trackGroup.length; i2++) {
                        if (i2 == 0) {
                            addView(this.inflater.inflate(R.layout.exo_list_divider, this, false));
                        }
                        CheckedTextView checkedTextView = (CheckedTextView) this.inflater.inflate(obj != null ? 17367056 : 17367055, this, false);
    ...
    private void onTrackViewClicked(View view) {
        ...
        if (this.override != null && this.override.groupIndex == intValue) {
