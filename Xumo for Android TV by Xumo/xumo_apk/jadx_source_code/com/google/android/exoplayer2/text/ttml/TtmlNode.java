...
final class TtmlNode {
    ...
    public boolean isActive(long j) {
        return (!(this.startTimeUs == C.TIME_UNSET && this.endTimeUs == C.TIME_UNSET) && ((this.startTimeUs > j || this.endTimeUs != C.TIME_UNSET) && ((this.startTimeUs != C.TIME_UNSET || j >= this.endTimeUs) && (this.startTimeUs > j || j >= this.endTimeUs)))) ? 0 : 1;
    }
    ...
    public List<Cue> getCues(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2) {
        ...
        for (Entry entry : treeMap.entrySet()) {
            ...
            arrayList.add(new Cue(cleanUpText((SpannableStringBuilder) entry.getValue()), null, ttmlRegion.line, ttmlRegion.lineType, ttmlRegion.lineAnchor, ttmlRegion.position, Integer.MIN_VALUE, ttmlRegion.width, ttmlRegion.textSizeType, ttmlRegion.textSize));
        }
        return arrayList;
    }
