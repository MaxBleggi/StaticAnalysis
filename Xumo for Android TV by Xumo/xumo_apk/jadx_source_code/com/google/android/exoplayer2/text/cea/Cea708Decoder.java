...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private static final class CueBuilder {
        ...
        public void defineWindow(boolean z, boolean z2, boolean z3, int i, boolean z4, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            if (this.rowCount != i11) {
                r0.rowCount = i11;
                while (true) {
                    if ((!z5 || r0.rolledUpCaptions.size() < r0.rowCount) && r0.rolledUpCaptions.size() < 15) {
                        break;
                    }
                    r0.rolledUpCaptions.remove(0);
                }
            }
            if (!(i9 == 0 || r0.windowStyleId == i9)) {
                r0.windowStyleId = i9;
                int i12 = i9 - 1;
                setWindowAttributes(WINDOW_STYLE_FILL[i12], COLOR_TRANSPARENT, WINDOW_STYLE_WORD_WRAP[i12], false, WINDOW_STYLE_PRINT_DIRECTION[i12], WINDOW_STYLE_SCROLL_DIRECTION[i12], WINDOW_STYLE_JUSTIFICATION[i12]);
            }
            if (i10 != 0 && r0.penStyleId != i10) {
                r0.penStyleId = i10;
                i12 = i10 - 1;
                setPenAttributes(false, true, 1, false, 0, PEN_STYLE_EDGE_TYPE[i12], PEN_STYLE_FONT_STYLE[i12]);
        ...
        public Cea708Cue build() {
            ...
            return new Cea708Cue(spannableStringBuilder, alignment2, f4, 0, i2, f3, i3, Cue.DIMEN_UNSET, this.windowFillColor != COLOR_SOLID_BLACK, this.windowFillColor, this.priority);
        }
    ...
    public Cea708Decoder(int i, List<byte[]> list) {
        ...
        this.currentCueBuilder = this.cueBuilders[null];
        resetCueBuilders();
    }
