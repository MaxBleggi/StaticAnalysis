...
*/
    ...
    L_0x004e:
        ...
        com.google.android.exoplayer2.util.Log.w(r2, r0);	 Catch:{ NumberFormatException -> 0x006d }
        goto L_0x0006;
    L_0x006d:
        r0 = "WebvttCueParser";
    ...
    static void parseCueText(String str, String str2, Builder builder, List<WebvttCssStyle> list) {
        ...
        while (i < str2.length()) {
            ...
            if (charAt == CHAR_AMPERSAND) {
                ...
                if (i2 < str2.length()) {
                    int i3 = 1;
                    Object obj = str2.charAt(i2) == CHAR_SLASH ? 1 : null;
                    i2 = findEndOfTag(str2, i2);
                    int i4 = i2 - 2;
                    Object obj2 = str2.charAt(i4) == CHAR_SLASH ? 1 : null;
                    if (obj != null) {
                        i3 = 2;
                    }
                    i += i3;
