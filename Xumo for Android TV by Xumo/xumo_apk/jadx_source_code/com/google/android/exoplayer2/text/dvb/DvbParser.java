...
final class DvbParser {
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i4 > 0) {
            ...
            d5 = d - d5;
            Double.isNaN(d2);
            i2 = (int) (d5 - (d2 * 0.71414d));
            Double.isNaN(d4);
            d4 *= 1.772d;
            Double.isNaN(d);
            iArr[readBits5] = getColor(b, Util.constrainValue(readBits6, 0, 255), Util.constrainValue(i2, 0, 255), Util.constrainValue((int) (d + d4), 0, 255));
            i4 = i5;
            readBits = i6;
            i2 = 8;
            i3 = 2;
        ...
        while (true) {
            ...
            if (readBits != 0) {
                ...
                if (!parsableBitArray.readBit()) {
                    if (!parsableBitArray.readBit()) {
                        switch (parsableBitArray.readBits(2)) {
                            ...
                            case 2:
                                ...
                                i5 = parsableBitArray.readBits(2);
                                break;
                            case 3:
                    ...
                    readBits = 3 + parsableBitArray.readBits(3);
                    i5 = parsableBitArray.readBits(2);
                }
                obj2 = obj;
                i6 = readBits;
        ...
        while (true) {
            ...
            if (readBits != 0) {
                ...
                if (parsableBitArray.readBit()) {
                    if (parsableBitArray.readBit()) {
                        switch (parsableBitArray.readBits(2)) {
                            ...
                            case 2:
                                ...
                                i5 = parsableBitArray.readBits(4);
                                break;
                            case 3:
                    ...
                    i5 = parsableBitArray.readBits(3);
                    if (i5 != 0) {
                        obj2 = obj;
                        i6 = i5 + 2;
                        i5 = 0;
