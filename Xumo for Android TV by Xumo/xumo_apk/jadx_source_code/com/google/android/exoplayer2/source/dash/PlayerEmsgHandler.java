...
public final class PlayerEmsgHandler implements Callback {
    ...
    boolean maybeRefreshManifestOnLoadingError(Chunk chunk) {
        ...
        chunk = (this.lastLoadedChunkEndTimeUs == C.TIME_UNSET || this.lastLoadedChunkEndTimeUs >= chunk.startTimeUs) ? null : true;
        if (chunk == null) {
            return false;
        }
        maybeNotifyDashManifestRefreshNeeded();
...
*/
        /*
        r2 = r2.messageData;	 Catch:{ ParserException -> 0x000b }
        r2 = com.google.android.exoplayer2.util.Util.fromUtf8Bytes(r2);	 Catch:{ ParserException -> 0x000b }
        r0 = com.google.android.exoplayer2.util.Util.parseXsDateTime(r2);	 Catch:{ ParserException -> 0x000b }
        return r0;
    L_0x000b:
