...
public abstract class SegmentBase {
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public final long getSegmentTimeUs(long j) {
            if (this.segmentTimeline != null) {
                j = ((SegmentTimelineElement) this.segmentTimeline.get((int) (j - this.startNumber))).startTime - this.presentationTimeOffset;
            } else {
    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            long j3 = j2;
            return new RangedUri(r0.mediaTemplate.buildUri(representation2.format.id, j, representation2.format.bitrate, j3), 0, -1);
        }
        ...
        public int getSegmentCount(long j) {
            ...
            return j != C.TIME_UNSET ? (int) Util.ceilDivide(j, (this.duration * 1000000) / this.timescale) : -1;
        }
    }
