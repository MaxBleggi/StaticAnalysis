    ...
    public final void load() throws IOException, InterruptedException {
        ...
        try {
            ...
            if (this.nextLoadPosition == 0) {
                ...
                this.extractorWrapper.init(output, this.clippedStartTimeUs == C.TIME_UNSET ? C.TIME_UNSET : this.clippedStartTimeUs - this.sampleOffsetUs, this.clippedEndTimeUs == C.TIME_UNSET ? C.TIME_UNSET : this.clippedEndTimeUs - this.sampleOffsetUs);
            }
