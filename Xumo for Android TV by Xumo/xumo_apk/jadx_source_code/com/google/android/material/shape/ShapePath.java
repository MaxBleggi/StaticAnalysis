...
public class ShapePath {
    ...
    public void addArc(float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        f5 = (double) (f5 + f6);
        this.endX = ((f + f3) * 0.5f) + (((f3 - f) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) * ((float) Math.cos(Math.toRadians(f5))));
        this.endY = ((f2 + f4) * 0.5f) + (((f4 - f2) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) * ((float) Math.sin(Math.toRadians(f5))));
    }
