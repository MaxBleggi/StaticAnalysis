...
public class MaterialCardView extends CardView {
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        context = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.MaterialCardView, i, R.style.Widget_MaterialComponents_CardView, new int[0]);
