...
class FloatingActionButtonImpl {
    ...
    private void calculateImageMatrixFromScale(float f, Matrix matrix) {
        ...
        if (drawable != null && this.maxImageSize != 0) {
            ...
            matrix.postScale(f, f, ((float) this.maxImageSize) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, ((float) this.maxImageSize) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
        }
    }
    ...
    private android.animation.ValueAnimator createElevationAnimator(@androidx.annotation.NonNull com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.ShadowAnimatorImpl r4) {
        /*
        r3 = this;
