...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        L_0x001b:
            r1 = r0.getLeft();
            r2 = r0.getRight();
            r3 = com.google.android.material.tabs.TabLayout.this;
        ...
        L_0x0029:
            ...
            if (r3 == 0) goto L_0x004a;
        L_0x002d:
            r0 = (com.google.android.material.tabs.TabLayout.TabView) r0;
            r1 = com.google.android.material.tabs.TabLayout.this;
            r1 = r1.tabViewContentBounds;
            r9.calculateTabViewContentBounds(r0, r1);
            r0 = com.google.android.material.tabs.TabLayout.this;
        ...
        L_0x0054:
            ...
            r1 = com.google.android.material.animation.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
            ...
            r11 = new com.google.android.material.tabs.TabLayout$SlidingTabIndicator$1;
            r3 = r11;
            r4 = r9;
            r3.<init>(r5, r6, r7, r8);
            r0.addUpdateListener(r11);
            r11 = new com.google.android.material.tabs.TabLayout$SlidingTabIndicator$2;
            r11.<init>(r10);
            r0.addListener(r11);
            r0.start();
        L_0x0082:
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.TabLayout, i, R.style.Widget_Design_TabLayout, R.styleable.TabLayout_tabTextAppearance);
        ...
        setSelectedTabIndicator(MaterialResources.getDrawable(context, attributeSet, R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorGravity(attributeSet.getInt(R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(attributeSet.getBoolean(R.styleable.TabLayout_tabIndicatorFullWidth, true));
        ...
        this.tabTextAppearance = attributeSet.getResourceId(R.styleable.TabLayout_tabTextAppearance, R.style.TextAppearance_Design_Tab);
        i = context.obtainStyledAttributes(this.tabTextAppearance, androidx.appcompat.R.styleable.TextAppearance);
        try {
            this.tabTextSize = (float) i.getDimensionPixelSize(androidx.appcompat.R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, i, androidx.appcompat.R.styleable.TextAppearance_android_textColor);
            if (attributeSet.hasValue(R.styleable.TabLayout_tabTextColor) != 0) {
                this.tabTextColors = MaterialResources.getColorStateList(context, attributeSet, R.styleable.TabLayout_tabTextColor);
            }
            if (attributeSet.hasValue(R.styleable.TabLayout_tabSelectedTextColor) != 0) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), attributeSet.getColor(R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context, attributeSet, R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(attributeSet.getInt(R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, attributeSet, R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = attributeSet.getInt(R.styleable.TabLayout_tabIndicatorAnimationDuration, ANIMATION_DURATION);
            ...
            this.tabTextMultiLineSize = (float) context.getDimensionPixelSize(R.dimen.design_tab_text_size_2line);
