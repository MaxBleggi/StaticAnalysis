...
public class MaterialButton extends AppCompatButton {
    ...
    public MaterialButton(Context context, AttributeSet attributeSet, int i) {
        ...
        context = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.MaterialButton, i, R.style.Widget_MaterialComponents_Button, new int[0]);
        this.iconPadding = context.getDimensionPixelSize(R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(context.getInt(R.styleable.MaterialButton_iconTintMode, -1), Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), context, R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), context, R.styleable.MaterialButton_icon);
