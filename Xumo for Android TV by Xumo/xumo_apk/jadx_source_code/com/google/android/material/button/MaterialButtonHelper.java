...
class MaterialButtonHelper {
    ...
    void drawStroke(@Nullable Canvas canvas) {
        if (canvas != null && this.strokeColor != null && this.strokeWidth > 0) {
            ...
            this.rectF.set((((float) this.bounds.left) + (((float) this.strokeWidth) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) + ((float) this.insetLeft), (((float) this.bounds.top) + (((float) this.strokeWidth) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) + ((float) this.insetTop), (((float) this.bounds.right) - (((float) this.strokeWidth) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) - ((float) this.insetRight), (((float) this.bounds.bottom) - (((float) this.strokeWidth) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) - ((float) this.insetBottom));
            float f = ((float) this.cornerRadius) - (((float) this.strokeWidth) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
