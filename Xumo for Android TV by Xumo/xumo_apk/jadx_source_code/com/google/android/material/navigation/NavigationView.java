...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = ThemeEnforcement.obtainTintedStyledAttributes(context, attributeSet, R.styleable.NavigationView, i, R.style.Widget_Design_NavigationView, new int[0]);
        ...
        this.maxWidth = attributeSet.getDimensionPixelSize(R.styleable.NavigationView_android_maxWidth, 0);
        ...
        if (attributeSet.hasValue(R.styleable.NavigationView_itemHorizontalPadding)) {
            this.presenter.setItemHorizontalPadding(attributeSet.getDimensionPixelSize(R.styleable.NavigationView_itemHorizontalPadding, 0));
        }
        int dimensionPixelSize = attributeSet.getDimensionPixelSize(R.styleable.NavigationView_itemIconPadding, 0);
