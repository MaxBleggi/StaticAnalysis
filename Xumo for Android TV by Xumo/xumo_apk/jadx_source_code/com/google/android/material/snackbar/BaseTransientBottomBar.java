    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (attributeSet.hasValue(R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) attributeSet.getDimensionPixelSize(R.styleable.SnackbarLayout_elevation, 0));
            }
    ...
    final void showView() {
        if (this.view.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                ...
                androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior newBehavior = this.behavior == null ? getNewBehavior() : this.behavior;
