...
public class AppBarLayout extends LinearLayout {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            if (attributeSet.hasValue(R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(context, attributeSet.getResourceId(R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        L_0x0006:
            ...
            r1 = (com.google.android.material.appbar.AppBarLayout.LayoutParams) r1;
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (T t2 = null; t2 < t; t2++) {
                androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior behavior = ((androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams) ((View) coordinatorLayout.get(t2)).getLayoutParams()).getBehavior();
