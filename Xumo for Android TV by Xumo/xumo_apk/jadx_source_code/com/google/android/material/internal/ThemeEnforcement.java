...
public final class ThemeEnforcement {
    ...
    private static void checkCompatibleTheme(Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        attributeSet = context.obtainStyledAttributes(attributeSet, R.styleable.ThemeEnforcement, i, i2);
        i = attributeSet.getBoolean(R.styleable.ThemeEnforcement_enforceMaterialTheme, 0);
    ...
    private static void checkTextAppearance(Context context, AttributeSet attributeSet, @StyleableRes int[] iArr, @AttrRes int i, @StyleRes int i2, @StyleableRes int... iArr2) {
        ...
        if (obtainStyledAttributes.getBoolean(R.styleable.ThemeEnforcement_enforceTextAppearance, false)) {
            ...
            context = obtainStyledAttributes.getResourceId(R.styleable.ThemeEnforcement_android_textAppearance, -1) != -1 ? true : null;
            obtainStyledAttributes.recycle();
            if (context != null) {
                throw new IllegalArgumentException("This component requires that you specify a valid TextAppearance attribute. Update your app theme to inherit from Theme.MaterialComponents (or a descendant).");
            }
