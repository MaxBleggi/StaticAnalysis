...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets() {
        ...
        if (i == 48) {
            ...
            this.collapsedDrawY = ((float) this.collapsedBounds.centerY()) + (((this.textPaint.descent() - this.textPaint.ascent()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - this.textPaint.descent());
        } else {
            this.collapsedDrawY = (float) this.collapsedBounds.bottom;
        }
        absoluteGravity &= GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (absoluteGravity == 1) {
            this.collapsedDrawX = ((float) this.collapsedBounds.centerX()) - (measureText / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
        ...
        if (i2 == 48) {
            ...
            this.expandedDrawY = ((float) this.expandedBounds.centerY()) + (((this.textPaint.descent() - this.textPaint.ascent()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - this.textPaint.descent());
        } else {
            this.expandedDrawY = (float) this.expandedBounds.bottom;
        }
        absoluteGravity2 &= GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (absoluteGravity2 == 1) {
            this.expandedDrawX = ((float) this.expandedBounds.centerX()) - (f2 / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    ...
    private void setInterpolatedTextSize(float f) {
        ...
        f = (USE_SCALING_TEXTURE == null || this.scale == 1.0f) ? 0.0f : Cue.DIMEN_UNSET;
        this.useTexture = f;
