...
public class CircularRevealHelper {
    ...
    public void setRevealInfo(@Nullable RevealInfo revealInfo) {
        if (revealInfo == null) {
            ...
            if (MathUtils.geq(revealInfo.radius, getDistanceToFurthestCorner(revealInfo), MathUtils.DEFAULT_EPSILON) != null) {
    ...
    private void drawOverlayDrawable(Canvas canvas) {
        if (shouldDrawOverlayDrawable()) {
            ...
            float width = this.revealInfo.centerX - (((float) bounds.width()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
            float height = this.revealInfo.centerY - (((float) bounds.height()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    ...
    private void drawDebugCircle(Canvas canvas, int i, float f) {
        ...
        canvas.drawCircle(this.revealInfo.centerX, this.revealInfo.centerY, this.revealInfo.radius - (f / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT), this.debugPaint);
    }
}
