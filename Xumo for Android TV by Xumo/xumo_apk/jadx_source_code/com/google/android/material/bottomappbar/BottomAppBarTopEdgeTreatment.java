...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment {
    ...
    public void getEdgePath(float f, float f2, ShapePath shapePath) {
        ...
        float f4 = ((r0.fabMargin * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) + r0.fabDiameter) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
        float f5 = f2 * r0.roundedCornerRadius;
        float f6 = (f3 / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) + r0.horizontalOffset;
        ...
        float f13 = f5 * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
        float f14 = toDegrees;
        shapePath.addArc(f9, 0.0f, f10 + f5, f13, 270.0f, toDegrees);
        shapePath.addArc(f6 - f4, (-f4) - f7, f6 + f4, f4 - f7, 180.0f - f12, (f12 * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - 180.0f);
