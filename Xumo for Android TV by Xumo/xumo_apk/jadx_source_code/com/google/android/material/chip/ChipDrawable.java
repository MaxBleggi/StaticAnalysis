...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Callback {
    ...
    private void loadFromAttributes(AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        i = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Chip, i, i2, new int[0]);
        setChipBackgroundColor(MaterialResources.getColorStateList(this.context, i, R.styleable.Chip_chipBackgroundColor));
        setChipMinHeight(i.getDimension(R.styleable.Chip_chipMinHeight, 0.0f));
        setChipCornerRadius(i.getDimension(R.styleable.Chip_chipCornerRadius, 0.0f));
        setChipStrokeColor(MaterialResources.getColorStateList(this.context, i, R.styleable.Chip_chipStrokeColor));
        setChipStrokeWidth(i.getDimension(R.styleable.Chip_chipStrokeWidth, 0.0f));
        setRippleColor(MaterialResources.getColorStateList(this.context, i, R.styleable.Chip_rippleColor));
        setText(i.getText(R.styleable.Chip_android_text));
        setTextAppearance(MaterialResources.getTextAppearance(this.context, i, R.styleable.Chip_android_textAppearance));
        switch (i.getInt(R.styleable.Chip_android_ellipsize, 0)) {
            case 1:
        ...
        setChipIconVisible(i.getBoolean(R.styleable.Chip_chipIconVisible, false));
        if (!(attributeSet == null || attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") == 0 || attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconVisible") != 0)) {
            setChipIconVisible(i.getBoolean(R.styleable.Chip_chipIconEnabled, false));
        }
        setChipIcon(MaterialResources.getDrawable(this.context, i, R.styleable.Chip_chipIcon));
        setChipIconTint(MaterialResources.getColorStateList(this.context, i, R.styleable.Chip_chipIconTint));
        setChipIconSize(i.getDimension(R.styleable.Chip_chipIconSize, 0.0f));
        setCloseIconVisible(i.getBoolean(R.styleable.Chip_closeIconVisible, false));
        if (!(attributeSet == null || attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") == 0 || attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconVisible") != 0)) {
            setCloseIconVisible(i.getBoolean(R.styleable.Chip_closeIconEnabled, false));
        }
        setCloseIcon(MaterialResources.getDrawable(this.context, i, R.styleable.Chip_closeIcon));
        setCloseIconTint(MaterialResources.getColorStateList(this.context, i, R.styleable.Chip_closeIconTint));
        setCloseIconSize(i.getDimension(R.styleable.Chip_closeIconSize, 0.0f));
        setCheckable(i.getBoolean(R.styleable.Chip_android_checkable, false));
        setCheckedIconVisible(i.getBoolean(R.styleable.Chip_checkedIconVisible, false));
        if (!(attributeSet == null || attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") == 0 || attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") != null)) {
            setCheckedIconVisible(i.getBoolean(R.styleable.Chip_checkedIconEnabled, false));
        }
        setCheckedIcon(MaterialResources.getDrawable(this.context, i, R.styleable.Chip_checkedIcon));
        setShowMotionSpec(MotionSpec.createFromAttribute(this.context, i, R.styleable.Chip_showMotionSpec));
        setHideMotionSpec(MotionSpec.createFromAttribute(this.context, i, R.styleable.Chip_hideMotionSpec));
        setChipStartPadding(i.getDimension(R.styleable.Chip_chipStartPadding, 0.0f));
        setIconStartPadding(i.getDimension(R.styleable.Chip_iconStartPadding, 0.0f));
        setIconEndPadding(i.getDimension(R.styleable.Chip_iconEndPadding, 0.0f));
        setTextStartPadding(i.getDimension(R.styleable.Chip_textStartPadding, 0.0f));
        setTextEndPadding(i.getDimension(R.styleable.Chip_textEndPadding, 0.0f));
        setCloseIconStartPadding(i.getDimension(R.styleable.Chip_closeIconStartPadding, 0.0f));
        setCloseIconEndPadding(i.getDimension(R.styleable.Chip_closeIconEndPadding, 0.0f));
        setChipEndPadding(i.getDimension(R.styleable.Chip_chipEndPadding, 0.0f));
        setMaxWidth(i.getDimensionPixelSize(R.styleable.Chip_android_maxWidth, Integer.MAX_VALUE));
        i.recycle();
    }
    ...
    private void drawChipStroke(@NonNull Canvas canvas, Rect rect) {
        if (this.chipStrokeWidth > 0.0f) {
            ...
            this.chipPaint.setColorFilter(getTintColorFilter());
            this.rectF.set(((float) rect.left) + (this.chipStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT), ((float) rect.top) + (this.chipStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT), ((float) rect.right) - (this.chipStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT), ((float) rect.bottom) - (this.chipStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT));
            rect = this.chipCornerRadius - (this.chipStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    ...
    private void calculateChipIconBounds(Rect rect, RectF rectF) {
        ...
        if (showsChipIcon() || showsCheckedIcon()) {
            ...
            rectF.top = rect.exactCenterY() - (this.chipIconSize / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    ...
    private float calculateTextCenterFromBaseline() {
        ...
        return (this.fontMetrics.descent + this.fontMetrics.ascent) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
    }
    ...
    private void calculateCloseIconBounds(Rect rect, RectF rectF) {
        ...
        if (showsCloseIcon()) {
            ...
            rectF.top = rect.exactCenterY() - (this.closeIconSize / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
