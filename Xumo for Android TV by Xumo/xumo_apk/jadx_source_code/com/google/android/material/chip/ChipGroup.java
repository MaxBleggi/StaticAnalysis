...
public class ChipGroup extends FlowLayout {
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        context = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.ChipGroup, i, R.style.Widget_MaterialComponents_ChipGroup, new int[0]);
        attributeSet = context.getDimensionPixelOffset(R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(context.getDimensionPixelOffset(R.styleable.ChipGroup_chipSpacingHorizontal, attributeSet));
        setChipSpacingVertical(context.getDimensionPixelOffset(R.styleable.ChipGroup_chipSpacingVertical, attributeSet));
        setSingleLine(context.getBoolean(R.styleable.ChipGroup_singleLine, false));
        setSingleSelection(context.getBoolean(R.styleable.ChipGroup_singleSelection, false));
        attributeSet = context.getResourceId(R.styleable.ChipGroup_checkedChip, -1);
        if (attributeSet != -1) {
