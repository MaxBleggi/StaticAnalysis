...
public class AvailabilityException extends Exception {
    ...
    public String getMessage() {
        ...
        Object obj = 1;
        for (zai com_google_android_gms_common_api_internal_zai : this.zaay.keySet()) {
            ConnectionResult connectionResult = (ConnectionResult) this.zaay.get(com_google_android_gms_common_api_internal_zai);
            if (connectionResult.isSuccess()) {
                obj = null;
            }
            String zan = com_google_android_gms_common_api_internal_zai.zan();
