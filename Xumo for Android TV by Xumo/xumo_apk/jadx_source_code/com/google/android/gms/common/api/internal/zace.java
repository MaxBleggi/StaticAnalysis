...
public final class zace extends zac implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    @WorkerThread
    public final void zaa(zach com_google_android_gms_common_api_internal_zach) {
        if (this.zaga != null) {
        ...
        this.zaki = com_google_android_gms_common_api_internal_zach;
    ...
    public final void zab(zaj com_google_android_gms_signin_internal_zaj) {
        this.mHandler.post(new zacg(this, com_google_android_gms_signin_internal_zaj));
    }

    @WorkerThread
    private final void zac(zaj com_google_android_gms_signin_internal_zaj) {
        ...
        if (connectionResult.isSuccess()) {
            ...
            if (connectionResult.isSuccess()) {
                this.zaki.zaa(com_google_android_gms_signin_internal_zaj.getAccountAccessor(), this.mScopes);
            } else {
