...
public final class StringToIntConverter extends AbstractSafeParcelable implements FieldConverter<String, Integer> {
    ...
    StringToIntConverter(@Param(id = 1) int i, @Param(id = 2) ArrayList<zaa> arrayList) {
        ...
        while (i2 < i) {
            ...
            i2++;
            zaa com_google_android_gms_common_server_converter_StringToIntConverter_zaa = (zaa) obj;
            add(com_google_android_gms_common_server_converter_StringToIntConverter_zaa.zapo, com_google_android_gms_common_server_converter_StringToIntConverter_zaa.zapp);
        }
    }
