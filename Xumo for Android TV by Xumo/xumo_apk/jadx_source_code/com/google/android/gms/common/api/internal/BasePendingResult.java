...
*/
    ...
    public final void zaa(zacs com_google_android_gms_common_api_internal_zacs) {
        this.zadt.set(com_google_android_gms_common_api_internal_zacs);
    }
    ...
    private final R get() {
        ...
        zacs com_google_android_gms_common_api_internal_zacs = (zacs) this.zadt.getAndSet(null);
        if (com_google_android_gms_common_api_internal_zacs != null) {
            com_google_android_gms_common_api_internal_zacs.zac(this);
        }
        return r;
    }
