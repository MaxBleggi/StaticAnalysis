...
public final class PendingResults {
    ...
    public static <R extends Result> PendingResult<R> immediateFailedResult(R r, GoogleApiClient googleApiClient) {
        ...
        PendingResult com_google_android_gms_common_api_PendingResults_zab = new zab(googleApiClient, r);
        com_google_android_gms_common_api_PendingResults_zab.setResult(r);
        return com_google_android_gms_common_api_PendingResults_zab;
    }

    @KeepForSdk
    public static <R extends Result> OptionalPendingResult<R> immediatePendingResult(R r) {
        Preconditions.checkNotNull(r, "Result must not be null");
        PendingResult com_google_android_gms_common_api_PendingResults_zac = new zac(null);
        com_google_android_gms_common_api_PendingResults_zac.setResult(r);
        return new OptionalPendingResultImpl(com_google_android_gms_common_api_PendingResults_zac);
    }

    @KeepForSdk
    public static <R extends Result> OptionalPendingResult<R> immediatePendingResult(R r, GoogleApiClient googleApiClient) {
        Preconditions.checkNotNull(r, "Result must not be null");
        PendingResult com_google_android_gms_common_api_PendingResults_zac = new zac(googleApiClient);
        com_google_android_gms_common_api_PendingResults_zac.setResult(r);
        return new OptionalPendingResultImpl(com_google_android_gms_common_api_PendingResults_zac);
    }
    ...
    public static <R extends Result> PendingResult<R> canceledPendingResult(R r) {
        ...
        PendingResult<R> com_google_android_gms_common_api_PendingResults_zaa = new zaa(r);
        com_google_android_gms_common_api_PendingResults_zaa.cancel();
        return com_google_android_gms_common_api_PendingResults_zaa;
    }
