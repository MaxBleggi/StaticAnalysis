...
public class GoogleApi<O extends ApiOptions> {
    ...
    @WorkerThread
    public Client zaa(Looper looper, zaa<O> com_google_android_gms_common_api_internal_GoogleApiManager_zaa_O) {
        return this.mApi.zai().buildClient(this.mContext, looper, createClientSettingsBuilder().build(), this.zabh, com_google_android_gms_common_api_internal_GoogleApiManager_zaa_O, com_google_android_gms_common_api_internal_GoogleApiManager_zaa_O);
    }
