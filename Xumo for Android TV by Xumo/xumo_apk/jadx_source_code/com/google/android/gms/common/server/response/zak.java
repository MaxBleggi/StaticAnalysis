...
public final class zak extends AbstractSafeParcelable {
    ...
    zak(@Param(id = 1) int i, @Param(id = 2) ArrayList<zal> arrayList, @Param(id = 3) String str) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            zal com_google_android_gms_common_server_response_zal = (zal) arrayList.get(i2);
            String str2 = com_google_android_gms_common_server_response_zal.className;
            HashMap hashMap = new HashMap();
            int size2 = com_google_android_gms_common_server_response_zal.zaqx.size();
            for (int i3 = 0; i3 < size2; i3++) {
                zam com_google_android_gms_common_server_response_zam = (zam) com_google_android_gms_common_server_response_zal.zaqx.get(i3);
                hashMap.put(com_google_android_gms_common_server_response_zam.zaqy, com_google_android_gms_common_server_response_zam.zaqz);
            }
            i.put(str2, hashMap);
        }
        this.zaqu = i;
