...
public class DataBufferSafeParcelable<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    private static final String[] zaln = new String[]{DataSchemeDataSource.SCHEME_DATA};
    ...
    public static <T extends SafeParcelable> void addValue(Builder builder, T t) {
        ...
        t = new ContentValues();
        t.put(DataSchemeDataSource.SCHEME_DATA, obtain.marshall());
        builder.withRow(t);
        obtain.recycle();
    }
    ...
    @KeepForSdk
    public T get(int i) {
        i = this.mDataHolder.getByteArray(DataSchemeDataSource.SCHEME_DATA, i, this.mDataHolder.getWindowIndex(i));
        Parcel obtain = Parcel.obtain();
