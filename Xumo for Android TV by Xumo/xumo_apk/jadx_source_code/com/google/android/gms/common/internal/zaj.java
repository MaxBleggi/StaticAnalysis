...
final class zaj implements StatusListener {
    ...
    zaj(PendingResult pendingResult, TaskCompletionSource taskCompletionSource, ResultConverter resultConverter, zaa com_google_android_gms_common_internal_PendingResultUtil_zaa) {
        this.zaou = pendingResult;
        this.zaov = taskCompletionSource;
        this.zaow = resultConverter;
        this.zaox = com_google_android_gms_common_internal_PendingResultUtil_zaa;
    }
