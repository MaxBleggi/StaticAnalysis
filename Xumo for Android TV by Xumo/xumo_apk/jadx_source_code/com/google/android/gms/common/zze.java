    ...
    public boolean equals(Object obj) {
        if (obj != null) {
            if (obj instanceof zzi) {
                try {
                    zzi com_google_android_gms_common_internal_zzi = (zzi) obj;
                    if (com_google_android_gms_common_internal_zzi.zzc() != hashCode()) {
                        return false;
                    }
                    obj = com_google_android_gms_common_internal_zzi.zzb();
                    if (obj == null) {
                        return false;
                    }
