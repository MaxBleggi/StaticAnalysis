...
public class PendingResultUtil {
    ...
    public static <R extends Result, T> Task<T> toTask(PendingResult<R> pendingResult, ResultConverter<R, T> resultConverter) {
        zaa com_google_android_gms_common_internal_PendingResultUtil_zaa = zaot;
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        pendingResult.addStatusListener(new zaj(pendingResult, taskCompletionSource, resultConverter, com_google_android_gms_common_internal_PendingResultUtil_zaa));
