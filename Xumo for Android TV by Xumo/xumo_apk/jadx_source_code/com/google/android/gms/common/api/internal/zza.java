...
public final class zza extends Fragment implements LifecycleFragment {
    ...
    public static zza zza(Activity activity) {
        zza com_google_android_gms_common_api_internal_zza;
        WeakReference weakReference = (WeakReference) zzbd.get(activity);
        if (weakReference != null) {
            com_google_android_gms_common_api_internal_zza = (zza) weakReference.get();
            if (com_google_android_gms_common_api_internal_zza != null) {
                return com_google_android_gms_common_api_internal_zza;
            }
        }
        try {
            com_google_android_gms_common_api_internal_zza = (zza) activity.getFragmentManager().findFragmentByTag("LifecycleFragmentImpl");
            if (com_google_android_gms_common_api_internal_zza == null || com_google_android_gms_common_api_internal_zza.isRemoving()) {
                com_google_android_gms_common_api_internal_zza = new zza();
                activity.getFragmentManager().beginTransaction().add(com_google_android_gms_common_api_internal_zza, "LifecycleFragmentImpl").commitAllowingStateLoss();
            }
            zzbd.put(activity, new WeakReference(com_google_android_gms_common_api_internal_zza));
            return com_google_android_gms_common_api_internal_zza;
