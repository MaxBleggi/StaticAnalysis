...
final class zzc {
    ...
    static zzm zza(String str, zze com_google_android_gms_common_zze, boolean z) {
        ThreadPolicy allowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            str = zzb(str, com_google_android_gms_common_zze, z);
            return str;
        } finally {
    ...
    private static zzm zzb(String str, zze com_google_android_gms_common_zze, boolean z) {
        try {
            if (zzn == null) {
            ...
            Preconditions.checkNotNull(zzp);
            try {
                if (zzn.zza(new zzk(str, com_google_android_gms_common_zze, z), ObjectWrapper.wrap(zzp.getPackageManager()))) {
                    return zzm.zze();
                }
                return zzm.zza(new zzd(z, str, com_google_android_gms_common_zze));
            } catch (String str2) {
            ...
            com_google_android_gms_common_zze = "module init: ";
            z = String.valueOf(str22.getMessage());
            return zzm.zza(z.length() != 0 ? com_google_android_gms_common_zze.concat(z) : new String(com_google_android_gms_common_zze), str22);
        }
    }

    static final /* synthetic */ String zza(boolean z, String str, zze com_google_android_gms_common_zze) throws Exception {
        boolean z2 = true;
        if (z || !zzb(str, com_google_android_gms_common_zze, true).zzac) {
            z2 = false;
        }
        return zzm.zza(str, com_google_android_gms_common_zze, z, z2);
    }
}
