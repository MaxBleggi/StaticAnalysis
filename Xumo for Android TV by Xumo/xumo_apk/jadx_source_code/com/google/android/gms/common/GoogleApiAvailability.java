...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @Nullable
    public final zabq zaa(Context context, zabr com_google_android_gms_common_api_internal_zabr) {
        IntentFilter intentFilter = new IntentFilter("android.intent.action.PACKAGE_ADDED");
        intentFilter.addDataScheme("package");
        BroadcastReceiver com_google_android_gms_common_api_internal_zabq = new zabq(com_google_android_gms_common_api_internal_zabr);
        context.registerReceiver(com_google_android_gms_common_api_internal_zabq, intentFilter);
        com_google_android_gms_common_api_internal_zabq.zac(context);
        if (isUninstalledAppPossiblyUpdating(context, "com.google.android.gms") != null) {
            return com_google_android_gms_common_api_internal_zabq;
        }
        com_google_android_gms_common_api_internal_zabr.zas();
        com_google_android_gms_common_api_internal_zabq.unregister();
        return null;
    }
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    str.addAction(R.drawable.common_full_open_on_phone, resources.getString(R.string.common_open_on_phone), pendingIntent);
                } else {
                    str.setContentIntent(pendingIntent);
                }
            } else {
                str.setSmallIcon(17301642).setTicker(resources.getString(R.string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(errorNotificationMessage);
            }
