...
final class zzu<TResult> extends Task<TResult> {
    ...
    private static class zza extends LifecycleCallback {
        ...
        public static zza zza(Activity activity) {
            ...
            zza com_google_android_gms_tasks_zzu_zza = (zza) activity.getCallbackOrNull("TaskOnStopCallback", zza.class);
            return com_google_android_gms_tasks_zzu_zza == null ? new zza(activity) : com_google_android_gms_tasks_zzu_zza;
        }
        ...
        public final <T> void zzb(zzq<T> com_google_android_gms_tasks_zzq_T) {
            synchronized (this.zzac) {
                this.zzac.add(new WeakReference(com_google_android_gms_tasks_zzq_T));
            }
        }
    ...
    public final Task<TResult> addOnSuccessListener(@NonNull Activity activity, @NonNull OnSuccessListener<? super TResult> onSuccessListener) {
        ...
        this.zzx.zza(com_google_android_gms_tasks_zzm);
        zza.zza(activity).zzb(com_google_android_gms_tasks_zzm);
        zze();
        return this;
    }
    ...
    public final Task<TResult> addOnFailureListener(@NonNull Activity activity, @NonNull OnFailureListener onFailureListener) {
        ...
        this.zzx.zza(com_google_android_gms_tasks_zzk);
        zza.zza(activity).zzb(com_google_android_gms_tasks_zzk);
        zze();
        return this;
    }
    ...
    public final Task<TResult> addOnCompleteListener(@NonNull Activity activity, @NonNull OnCompleteListener<TResult> onCompleteListener) {
        ...
        this.zzx.zza(com_google_android_gms_tasks_zzi);
        zza.zza(activity).zzb(com_google_android_gms_tasks_zzi);
        zze();
        return this;
    }
    ...
    public final <TContinuationResult> Task<TContinuationResult> continueWith(@NonNull Executor executor, @NonNull Continuation<TResult, TContinuationResult> continuation) {
        ...
        this.zzx.zza(new zzc(executor, continuation, com_google_android_gms_tasks_zzu));
        zze();
    ...
    public final Task<TResult> addOnCanceledListener(@NonNull Activity activity, @NonNull OnCanceledListener onCanceledListener) {
        ...
        this.zzx.zza(com_google_android_gms_tasks_zzg);
        zza.zza(activity).zzb(com_google_android_gms_tasks_zzg);
        zze();
        return this;
    }
    ...
    public final <TContinuationResult> Task<TContinuationResult> continueWithTask(@NonNull Executor executor, @NonNull Continuation<TResult, Task<TContinuationResult>> continuation) {
        Task com_google_android_gms_tasks_zzu = new zzu();
        this.zzx.zza(new zze(executor, continuation, com_google_android_gms_tasks_zzu));
        zze();
        return com_google_android_gms_tasks_zzu;
    }
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccessTask(Executor executor, SuccessContinuation<TResult, TContinuationResult> successContinuation) {
        Task com_google_android_gms_tasks_zzu = new zzu();
        this.zzx.zza(new zzo(executor, successContinuation, com_google_android_gms_tasks_zzu));
        zze();
        return com_google_android_gms_tasks_zzu;
    }
