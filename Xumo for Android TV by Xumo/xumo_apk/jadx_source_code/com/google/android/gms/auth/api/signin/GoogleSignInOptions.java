...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    public static GoogleSignInOptions zab(@Nullable String str) throws JSONException {
        ...
        return new GoogleSignInOptions(3, new ArrayList(str), !TextUtils.isEmpty(optString) ? new Account(optString, AccountType.GOOGLE) : null, jSONObject.getBoolean("idTokenRequested"), jSONObject.getBoolean("serverAuthRequested"), jSONObject.getBoolean("forceCodeForRefreshToken"), jSONObject.optString("serverClientId", null), jSONObject.optString("hostedDomain", null), new HashMap());
    }
...
*/
    ...
    L_0x0054:
        r1 = r4.getServerClientId();	 Catch:{ ClassCastException -> 0x0088 }
        r1 = android.text.TextUtils.isEmpty(r1);	 Catch:{ ClassCastException -> 0x0088 }
        if (r1 == 0) goto L_0x0085;	 Catch:{ ClassCastException -> 0x0088 }
    L_0x005e:
    ...
    L_0x005f:
        r1 = r3.zaab;	 Catch:{ ClassCastException -> 0x0088 }
        r2 = r4.getServerClientId();	 Catch:{ ClassCastException -> 0x0088 }
        r1 = r1.equals(r2);	 Catch:{ ClassCastException -> 0x0088 }
        if (r1 == 0) goto L_0x0085;	 Catch:{ ClassCastException -> 0x0088 }
    L_0x006b:
        r1 = r3.zaaa;	 Catch:{ ClassCastException -> 0x0088 }
        r2 = r4.isForceCodeForRefreshToken();	 Catch:{ ClassCastException -> 0x0088 }
        if (r1 != r2) goto L_0x0085;	 Catch:{ ClassCastException -> 0x0088 }
    L_0x0073:
        r1 = r3.zay;	 Catch:{ ClassCastException -> 0x0088 }
        r2 = r4.isIdTokenRequested();	 Catch:{ ClassCastException -> 0x0088 }
        if (r1 != r2) goto L_0x0085;	 Catch:{ ClassCastException -> 0x0088 }
    L_0x007b:
        r1 = r3.zaz;	 Catch:{ ClassCastException -> 0x0088 }
        r4 = r4.isServerAuthCodeRequested();	 Catch:{ ClassCastException -> 0x0088 }
