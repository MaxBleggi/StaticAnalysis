...
final class zzan extends zzc {
    ...
    private final /* synthetic */ String zzpk;
    private final /* synthetic */ List zzpl;

    zzan(RemoteMediaClient remoteMediaClient, GoogleApiClient googleApiClient, boolean z, String str, List list) {
...
*/
        ...
        r4 = r4.lock;
        monitor-enter(r4);
        r0 = r3.zzpe;	 Catch:{ IllegalStateException -> 0x0017 }
        r0 = r0.zzfl;	 Catch:{ IllegalStateException -> 0x0017 }
        r1 = r3.zzpk;	 Catch:{ IllegalStateException -> 0x0017 }
        r2 = r3.zzpl;	 Catch:{ IllegalStateException -> 0x0017 }
    ...
    L_0x0029:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.cast.framework.media.zzan.zzb(com.google.android.gms.internal.cast.zzco):void");
    }
}
