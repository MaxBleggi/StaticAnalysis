...
final class zzaa extends zzc {
    ...
    zzaa(RemoteMediaClient remoteMediaClient, GoogleApiClient googleApiClient, MediaQueueItem[] mediaQueueItemArr, JSONObject jSONObject) {
...
*/
        ...
        r11 = r11.lock;
        monitor-enter(r11);
        r0 = r10.zzpe;	 Catch:{ IllegalStateException -> 0x001e, IllegalStateException -> 0x001e }
        r1 = r0.zzfl;	 Catch:{ IllegalStateException -> 0x001e, IllegalStateException -> 0x001e }
        r2 = r10.zzgr;	 Catch:{ IllegalStateException -> 0x001e, IllegalStateException -> 0x001e }
        ...
        r6 = r10.zzgc;	 Catch:{ IllegalStateException -> 0x001e, IllegalStateException -> 0x001e }
        ...
        r9 = r10.zzfy;	 Catch:{ IllegalStateException -> 0x001e, IllegalStateException -> 0x001e }
    ...
    L_0x0030:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.cast.framework.media.zzaa.zzb(com.google.android.gms.internal.cast.zzco):void");
    }
}
