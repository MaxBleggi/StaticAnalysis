...
final class zzad extends zzc {
    ...
    zzad(RemoteMediaClient remoteMediaClient, GoogleApiClient googleApiClient, int[] iArr, int i, JSONObject jSONObject) {
...
*/
        ...
        r6 = r6.lock;
        monitor-enter(r6);
        r0 = r5.zzpe;	 Catch:{ IllegalStateException -> 0x001b, IllegalStateException -> 0x001b }
        r0 = r0.zzfl;	 Catch:{ IllegalStateException -> 0x001b, IllegalStateException -> 0x001b }
        r1 = r5.zzgr;	 Catch:{ IllegalStateException -> 0x001b, IllegalStateException -> 0x001b }
        r2 = r5.zzge;	 Catch:{ IllegalStateException -> 0x001b, IllegalStateException -> 0x001b }
        r3 = r5.zzga;	 Catch:{ IllegalStateException -> 0x001b, IllegalStateException -> 0x001b }
        r4 = r5.zzfy;	 Catch:{ IllegalStateException -> 0x001b, IllegalStateException -> 0x001b }
    ...
    L_0x002d:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.cast.framework.media.zzad.zzb(com.google.android.gms.internal.cast.zzco):void");
    }
}
