...
public final class VideoInfo extends AbstractSafeParcelable {
    public static final Creator<VideoInfo> CREATOR = new zzbx();
    ...
    public final boolean equals(Object obj) {
        ...
        return this.height == videoInfo.getHeight() && this.width == videoInfo.getWidth() && this.zzhc == videoInfo.getHdrType();
    }

    public final int hashCode() {
        return Objects.hashCode(Integer.valueOf(this.height), Integer.valueOf(this.width), Integer.valueOf(this.zzhc));
    }

    static VideoInfo zzh(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        try {
            ...
            Log.d("VideoInfo", String.format(Locale.ROOT, "Error while creating a VideoInfo instance from JSON: %s", new Object[]{jSONObject2.getMessage()}));
            return null;
        }
    }
}
