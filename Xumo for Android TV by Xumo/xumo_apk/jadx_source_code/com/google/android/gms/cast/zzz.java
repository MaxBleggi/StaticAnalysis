...
*/
    ...
    L_0x0007:
        ...
        return;
    L_0x0018:
        r0 = com.google.android.gms.cast.CastRemoteDisplayLocalService.zzbe;
        r2 = "startRemoteDisplay successful";
        r3 = new java.lang.Object[r1];
        r0.d(r2, r3);
        r0 = com.google.android.gms.cast.CastRemoteDisplayLocalService.zzbp;
        monitor-enter(r0);
        r2 = com.google.android.gms.cast.CastRemoteDisplayLocalService.zzcf;	 Catch:{ all -> 0x0098 }
        if (r2 != 0) goto L_0x0040;	 Catch:{ all -> 0x0098 }
    L_0x002e:
        r5 = com.google.android.gms.cast.CastRemoteDisplayLocalService.zzbe;	 Catch:{ all -> 0x0098 }
    ...
    L_0x0069:
        ...
        if (r5 == 0) goto L_0x0097;
    L_0x0071:
        r5 = r4.zzch;	 Catch:{ IllegalArgumentException -> 0x0081 }
        r5 = r5.zzbz;	 Catch:{ IllegalArgumentException -> 0x0081 }
        r0 = r4.zzch;	 Catch:{ IllegalArgumentException -> 0x0081 }
        r0 = r0.zzca;	 Catch:{ IllegalArgumentException -> 0x0081 }
