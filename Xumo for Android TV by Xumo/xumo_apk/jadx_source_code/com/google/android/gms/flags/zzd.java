    ...
    protected final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        switch (i) {
            case 1:
                ...
                break;
            case 2:
                i = getBooleanFlagValue(parcel.readString(), zzc.zza(parcel), parcel.readInt());
                parcel2.writeNoException();
            ...
            case 3:
                ...
                break;
            case 4:
                i = getLongFlagValue(parcel.readString(), parcel.readLong(), parcel.readInt());
                parcel2.writeNoException();
                parcel2.writeLong(i);
                break;
            case 5:
                i = getStringFlagValue(parcel.readString(), parcel.readString(), parcel.readInt());
                parcel2.writeNoException();
