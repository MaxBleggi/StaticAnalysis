...
interface zzzh {
    ...
    void zza(int i, zzun com_google_android_gms_internal_measurement_zzun) throws IOException;

    <K, V> void zza(int i, zzwx<K, V> com_google_android_gms_internal_measurement_zzwx_K__V, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzxu com_google_android_gms_internal_measurement_zzxu) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzxu com_google_android_gms_internal_measurement_zzxu) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzxu com_google_android_gms_internal_measurement_zzxu) throws IOException;
    ...
    @Deprecated
    void zzb(int i, List<?> list, zzxu com_google_android_gms_internal_measurement_zzxu) throws IOException;
