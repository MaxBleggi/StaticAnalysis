...
public final class zzzu {
    ...
    public static final int zzb(zzzi com_google_android_gms_internal_measurement_zzzi, int i) throws IOException {
        int position = com_google_android_gms_internal_measurement_zzzi.getPosition();
        com_google_android_gms_internal_measurement_zzzi.zzap(i);
        int i2 = 1;
        while (com_google_android_gms_internal_measurement_zzzi.zzuq() == i) {
            com_google_android_gms_internal_measurement_zzzi.zzap(i);
            i2++;
        }
        com_google_android_gms_internal_measurement_zzzi.zzt(position, i);
        return i2;
    }
}
