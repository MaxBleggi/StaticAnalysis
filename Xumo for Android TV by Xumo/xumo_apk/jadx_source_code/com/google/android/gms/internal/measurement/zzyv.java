...
final class zzyv {
    ...
    private static void zza(byte b, byte b2, char[] cArr, int i) throws zzwe {
        if (b < (byte) -62 || zzg(b2)) {
            throw zzwe.zzxe();
        }
    ...
    private static void zza(byte b, byte b2, byte b3, char[] cArr, int i) throws zzwe {
    ...
    private static void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzwe {
