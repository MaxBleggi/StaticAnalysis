...
public final class zae extends Drawable implements Callback {
    ...
    public zae(Drawable drawable, Drawable drawable2) {
        ...
        zai com_google_android_gms_internal_base_zai = this.zanm;
        com_google_android_gms_internal_base_zai.zanv = drawable.getChangingConfigurations() | com_google_android_gms_internal_base_zai.zanv;
        if (drawable2 == null) {
            drawable2 = zag.zant;
        }
        this.zano = drawable2;
    ...
    zae(zai com_google_android_gms_internal_base_zai) {
        this.zang = 0;
        this.zanj = 255;
        this.mAlpha = 0;
        this.zamy = true;
        this.zanm = new zai(com_google_android_gms_internal_base_zai);
    }
