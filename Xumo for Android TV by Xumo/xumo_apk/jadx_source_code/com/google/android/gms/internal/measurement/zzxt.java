...
interface zzxt {
    ...
    <T> T zza(zzxu<T> com_google_android_gms_internal_measurement_zzxu_T, zzvk com_google_android_gms_internal_measurement_zzvk) throws IOException;

    <T> void zza(List<T> list, zzxu<T> com_google_android_gms_internal_measurement_zzxu_T, zzvk com_google_android_gms_internal_measurement_zzvk) throws IOException;

    <K, V> void zza(Map<K, V> map, zzwx<K, V> com_google_android_gms_internal_measurement_zzwx_K__V, zzvk com_google_android_gms_internal_measurement_zzvk) throws IOException;

    @Deprecated
    <T> T zzb(zzxu<T> com_google_android_gms_internal_measurement_zzxu_T, zzvk com_google_android_gms_internal_measurement_zzvk) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzxu<T> com_google_android_gms_internal_measurement_zzxu_T, zzvk com_google_android_gms_internal_measurement_zzvk) throws IOException;
