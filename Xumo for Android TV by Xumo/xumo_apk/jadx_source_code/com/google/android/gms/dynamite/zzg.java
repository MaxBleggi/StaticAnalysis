...
final class zzg implements VersionPolicy {
    ...
    public final zzb zza(Context context, String str, zza com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zza) throws LoadingException {
        ...
        if (com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zzb.zziq != 0) {
            com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zzb.zzir = com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zza.zza(context, str, false);
        } else {
        ...
        if (com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zzb.zziq == null && com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zzb.zzir == null) {
            com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zzb.zzis = 0;
        } else if (com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zzb.zzir >= com_google_android_gms_dynamite_DynamiteModule_VersionPolicy_zzb.zziq) {
