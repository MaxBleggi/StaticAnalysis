    ...
    private Map<String, BoundField> getBoundFields(Gson gson, TypeToken<?> typeToken, Class<?> cls) {
        ...
        while (cls2 != Object.class) {
            ...
            while (i < length) {
                ...
                boolean excludeField2 = excludeField(accessibleObject, z);
                if (excludeField || excludeField2) {
                    ...
                    while (i2 < size) {
                        ...
                        boundField2 = boundField == null ? (BoundField) linkedHashMap.put(str2, createBoundField(gson, accessibleObject, str2, TypeToken.get(resolve), z2, excludeField2)) : boundField;
                        i2 = i3 + 1;
                        excludeField = z2;
                        fieldNames = list;
                        size = i4;
