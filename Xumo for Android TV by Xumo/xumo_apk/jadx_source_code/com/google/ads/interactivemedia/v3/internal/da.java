...
public final class da implements cc, cj {
    ...
    private boolean b(cd cdVar) throws IOException, InterruptedException {
        ...
        if (b(this.h)) {
            ...
            fe.b(this.j == 8 ? true : null);
            fe.b(this.i <= 2147483647L ? true : null);
    ...
    private int c(cd cdVar, ch chVar) throws IOException, InterruptedException {
        ...
        if (c >= 0) {
            if (c < PlaybackStateCompat.ACTION_SET_REPEAT_MODE) {
                cdVar.b((int) c);
                this.l = aVar.b.c[i];
                if (aVar.a.p != -1) {
                    chVar = this.c.a;
                    ...
                    while (this.m < this.l) {
                        chVar = ckVar.a(cdVar, this.l - this.m, false);
                        this.m += chVar;
                        this.n -= chVar;
                    }
                }
                long j2 = aVar.b.e[i];
                cdVar = aVar.b.f[i];
                ckVar.a(j2, cdVar, this.l, 0, null);
                aVar.d += 1;
                this.m = 0;
                this.n = 0;
                return 0;
    ...
    private static boolean a(int i) {
        if (!(i == cv.R || i == cv.C || i == cv.S || i == cv.T || i == cv.am || i == cv.an || i == cv.ao || i == cv.Q || i == cv.ap || i == cv.aq || i == cv.ar || i == cv.as || i == cv.at || i == cv.O || i == cv.a)) {
            if (i != cv.az) {
                return false;
            }
        }
    ...
    private static boolean b(int i) {
        if (!(i == cv.B || i == cv.D || i == cv.E || i == cv.F || i == cv.G)) {
            if (i != cv.P) {
                return false;
            }
        }
