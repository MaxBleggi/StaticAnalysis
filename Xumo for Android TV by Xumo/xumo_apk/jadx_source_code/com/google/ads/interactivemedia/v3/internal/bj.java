...
public final class bj implements Parcelable {
    ...
    bj(String str, String str2, int i, int i2, long j, int i3, int i4, int i5, float f, int i6, int i7, String str3, long j2, List<byte[]> list, boolean z, int i8, int i9, int i10, int i11, int i12, byte[] bArr, int i13, aw awVar) {
        ...
        this.v = str3;
        this.w = j2;
        r0.f = list == null ? Collections.emptyList() : list;
        r0.g = z;
        r0.j = i8;
        r0.k = i9;
        r0.s = i10;
    ...
    public bj a(int i) {
        int i2 = i;
        return new bj(this.a, this.b, this.c, i2, this.e, this.h, this.i, this.l, this.m, this.q, this.r, this.v, this.w, this.f, this.g, this.j, this.k, this.s, this.t, this.u, this.o, this.n, this.p);
    }

    public bj a(int i, int i2) {
        int i3 = i;
        int i4 = i2;
        return new bj(this.a, this.b, this.c, this.d, this.e, this.h, this.i, this.l, this.m, this.q, this.r, this.v, this.w, this.f, this.g, this.j, this.k, this.s, i3, i4, this.o, this.n, this.p);
    }
    ...
    public String toString() {
        ...
        int i11 = this.t;
        int i12 = this.u;
        StringBuilder stringBuilder = new StringBuilder(((String.valueOf(str).length() + 219) + String.valueOf(str2).length()) + String.valueOf(str3).length());
