...
class BinaryImagesConverter {
    ...
    private JSONArray parseProcMapsJsonFromString(String str) {
        ...
        try {
            ...
            Fabric.getLogger().w(CrashlyticsCore.TAG, "Unable to parse proc maps string", str2);
            return jSONArray;
        }
    }
            ...
            if (isRelevant(str)) {
                try {
                    try {
                        ...
                        Fabric.getLogger().d(CrashlyticsCore.TAG, "Could not create a binary image json string", str2);
                        return null;
                    }
                } catch (Throwable e) {
                    ...
                    logger.d(str3, stringBuilder.toString(), e);
                    return null;
                }
            }
        }
    ...
    private static byte[] generateBinaryImagesJsonString(JSONArray jSONArray) {
        ...
        try {
            ...
            Fabric.getLogger().w(CrashlyticsCore.TAG, "Binary images string is null", jSONArray2);
    ...
    private static JSONObject createBinaryImageJson(String str, ProcMapEntry procMapEntry) throws JSONException {
        ...
        jSONObject.put(JsonKey.NAME, procMapEntry.path);
