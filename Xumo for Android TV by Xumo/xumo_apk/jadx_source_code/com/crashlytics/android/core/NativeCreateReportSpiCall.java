...
class NativeCreateReportSpiCall extends AbstractSpiCall implements CreateReportSpiCall {
    ...
    private HttpRequest applyHeadersTo(HttpRequest httpRequest, String str) {
        ...
        httpRequest.header("User-Agent", stringBuilder.toString()).header(AbstractSpiCall.HEADER_CLIENT_TYPE, "android").header(AbstractSpiCall.HEADER_CLIENT_VERSION, this.kit.getVersion()).header(AbstractSpiCall.HEADER_API_KEY, str);
        return httpRequest;
    }
