...
class CrashlyticsController {
        ...
        this.backgroundWorker.submitAndWait(new Callable<Void>() {
            public Void call() throws Exception {
                ...
                if (settingsData != null) {
                    ...
                    featuresSettingsData = sessionSettingsData;
                }
                Object obj2 = null;
                if (featuresSettingsData != null) {
                    if (!featuresSettingsData.firebaseCrashlyticsEnabled) {
                        obj = null;
                        if (obj != null || z2) {
    ...
    private void closeWithoutRenamingOrLog(ClsFileOutputStream clsFileOutputStream) {
        if (clsFileOutputStream != null) {
            try {
                ...
                Fabric.getLogger().e(CrashlyticsCore.TAG, "Error closing session file stream in the presence of an exception", clsFileOutputStream2);
            }
        }
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Fabric.getLogger().e(CrashlyticsCore.TAG, "An error occurred in the fatal exception logger", date);
    ...
    private void doWriteNonFatal(Date date, Thread thread, Throwable th) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    flushable = newInstance;
                    try {
                        Fabric.getLogger().e(CrashlyticsCore.TAG, "An error occurred in the non-fatal exception logger", date);
        ...
        try {
            ...
            Fabric.getLogger().e(CrashlyticsCore.TAG, "An error occurred when trimming non-fatal files.", date2);
        }
    }
    ...
    private static void writeNonFatalEventsTo(CodedOutputStream codedOutputStream, File[] fileArr, String str) {
        ...
        for (File name : fileArr) {
            try {
                Fabric.getLogger().d(CrashlyticsCore.TAG, String.format(Locale.US, "Found Non Fatal for session ID %s in %s ", new Object[]{str, name.getName()}));
    ...
    private void writeInitialPartsTo(CodedOutputStream codedOutputStream, String str) throws IOException {
        for (String str2 : INITIAL_SESSION_PART_TAGS) {
            ...
            if (listFilesMatching.length == 0) {
                ...
                stringBuilder2.append(str);
                logger.e(str3, stringBuilder2.toString(), null);
            } else {
                Logger logger2 = Fabric.getLogger();
                ...
                stringBuilder3.append(str);
                logger2.d(str4, stringBuilder3.toString());
    ...
    void registerAnalyticsEventListener(SettingsData settingsData) {
        if (settingsData.featuresData.firebaseCrashlyticsEnabled != null && this.appMeasurementEventListenerRegistrar.register() != null) {
